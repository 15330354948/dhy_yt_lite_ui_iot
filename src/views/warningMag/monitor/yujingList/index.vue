    ...
    <basic-container>
      ...
      >
        <template slot="menuLeft">
          <el-button @click="handleEdit"  v-if="permissions.warning_realTime_process" class="filter-item" type="primary"
            >预警流程
          </el-button>
          <!-- <el-button
        ...
        <template slot-scope="scope" slot="menu">
          ...
          v-if="permissions.warning_realTime_viewBtn"
            >查看</el-button
          >
...
export default {
  ...
  created() {
    ...
    this.searchForm.disposeStatus = 1;
  },
  mounted() {
    this.option.column[9].hide = false;
    this.option.column[10].hide = true;
    this.option.column[9].search = true;
    this.option.column[10].search = false;
    if(this.permissions.warning_realTime_levelConfirmBtn){
       this.show= true
    }else{
        this.show= false
    }
  ...
  methods: {
    ...
    handleEdit() {
      ...
      getYujin({
        ...
        if(recData&&JSON.stringify(recData)!='{}'){
