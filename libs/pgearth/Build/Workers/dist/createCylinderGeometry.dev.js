...
!function () {
  define("Core/defined", [], function () {
    ...
    function i(n, i, u, s, c) {
      ...
      do {
        b -= B, w = 1 / (1 + b * S), g = 1 / (1 + b * N), C = 1 / (1 + b * I), x = w * w, U = g * g, P = C * C, D = x * w, F = U * g, L = P * C, v = _ * x + m * U + y * P - 1, M = _ * D * S + m * F * N + y * L * I;
        B = v / (-2 * M);
    ...
    s.packedLength = 9, s.pack = function (e, t, r) {
      ...
      return r(t) ? (t[0] = E, t[1] = m, t[2] = R, t[3] = p, t[4] = y, t[5] = A, t[6] = _, t[7] = T, t[8] = S, t) : new s(E, p, _, m, y, T, R, A, S);
    ...
    l.packedLength = 16, l.pack = function (e, t, n) {
      ...
      return r[0] = T * a, r[1] = S * a, r[2] = O * a, r[3] = 0, r[4] = R * o, r[5] = N * o, r[6] = v * o, r[7] = 0, r[8] = A * u, r[9] = I * u, r[10] = M * u, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, r;
    ...
    l.fromCamera = function (t, n) {
      ...
      var u = h.x,
          ...
          I = m * -R + y * -A + T * -S,
          O = E * R + p * A + _ * S;
      return i(n) ? (n[0] = u, n[1] = m, n[2] = -E, n[3] = 0, n[4] = s, n[5] = y, n[6] = -p, n[7] = 0, n[8] = c, n[9] = T, n[10] = -_, n[11] = 0, n[12] = N, n[13] = I, n[14] = O, n[15] = 1, n) : new l(u, s, c, N, m, y, T, I, -E, -p, -_, O, 0, 0, 0, 1);
    ...
    l.getMaximumScale = function (t) {
      ...
      var r = e[0],
          ...
          K = a * x + c * U + d * P + m * D,
          Z = o * x + l * U + E * P + y * D;
      return n[0] = F, n[1] = L, n[2] = b, n[3] = B, n[4] = z, n[5] = q, n[6] = G, n[7] = V, n[8] = X, n[9] = W, n[10] = H, n[11] = Y, n[12] = k, n[13] = j, n[14] = K, n[15] = Z, n;
      ...
      var r = e[0],
          ...
          b = i * I + u * O + l * v + d,
          B = a * I + s * O + f * v + E;
      return n[0] = M, n[1] = w, n[2] = g, n[3] = 0, n[4] = C, n[5] = x, n[6] = U, n[7] = 0, n[8] = P, n[9] = D, n[10] = F, n[11] = 0, n[12] = L, n[13] = b, n[14] = B, n[15] = 1, n;
      ...
      var r = e[0],
          ...
          w = i * y + u * T + l * R,
          g = a * y + s * T + f * R;
      return n[0] = A, n[1] = S, n[2] = N, n[3] = 0, n[4] = I, n[5] = O, n[6] = v, n[7] = 0, n[8] = M, n[9] = w, n[10] = g, n[11] = 0, n[12] = e[12], n[13] = e[13], n[14] = e[14], n[15] = e[15], n;
    ...
    return l.inverse = function (e, n) {
      ...
      M = a * E, w = o * d, g = i * E, C = o * h, x = i * d, U = a * h, P = r * E, D = o * f, F = r * d, L = a * f, b = r * h, B = i * f;
      ...
      return te = 1 / te, n[0] = z * te, n[1] = q * te, n[2] = G * te, n[3] = V * te, n[4] = X * te, n[5] = W * te, n[6] = H * te, n[7] = Y * te, n[8] = k * te, n[9] = j * te, n[10] = K * te, n[11] = Z * te, n[12] = J * te, n[13] = Q * te, n[14] = $ * te, n[15] = ee * te, n;
    ...
    d.fromPoints = function (t, n) {
      ...
      var F = S;
      F.x = .5 * (U.x + P.x), F.y = .5 * (U.y + P.y), F.z = .5 * (U.z + P.z);
    ...
    function d() {
      if (!t(x)) {
        x = !1;
        var e;
        "Microsoft Internet Explorer" === I.appName ? null !== (e = /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(I.userAgent)) && (x = !0, U = o(e[1])) : "Netscape" === I.appName && null !== (e = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(I.userAgent)) && (x = !0, U = o(e[1]));
      }
    ...
    var O, v, M, w, g, C, x, U, P, D, F, L, b, B, z, q;
    N._promise = void 0, N._result = void 0, N.initialize = function () {
      ...
      return n.onload = function () {
        N._result = n.width > 0 && n.height > 0, e.resolve(N._result);
      }, n.onerror = function () {
    ...
    var t = {};
    return t.computePositions = function (t, n, r, i, a) {
      var o,
          u = .5 * t,
          s = -u,
          c = i + i,
      ...
      for (o = 0; o < i; o++) {
        ...
        f[d + E] = T, f[d + E + 1] = R, f[d + E + 2] = s, f[d + p] = A, f[d + p + 1] = S, f[d + p + 2] = u, d += 3, a && (f[h++] = T, f[h++] = R, f[h++] = s, f[h++] = A, f[h++] = S, f[h++] = u);
      }
    ...
    s.slerp = function (e, t, n, r) {
      ...
      var u = Math.acos(i);
      return N = s.multiplyByScalar(e, Math.sin((1 - n) * u), N), I = s.multiplyByScalar(a, Math.sin(n * u), I), r = s.add(N, I, r), s.multiplyByScalar(r, 1 / Math.sin(u), r);
    }, s.log = function (t, n) {
    ...
    for (var g = new s(), C = 1.9011074535173003, x = i.supportsTypedArrays() ? new Float32Array(8) : [], U = i.supportsTypedArrays() ? new Float32Array(8) : [], P = i.supportsTypedArrays() ? new Float32Array(8) : [], D = i.supportsTypedArrays() ? new Float32Array(8) : [], F = 0; F < 7; ++F) {
      var L = F + 1,
          b = 2 * L + 1;
      x[F] = 1 / (L * b), U[F] = L / b;
    }

    return x[7] = C / 136, U[7] = 8 * C / 17, s.fastSlerp = function (e, t, n, r) {
      var i,
          a = s.dot(e, t);
      a >= 0 ? i = 1 : (i = -1, a = -a);
      ...
      var h = i * n * (1 + P[0] * (1 + P[1] * (1 + P[2] * (1 + P[3] * (1 + P[4] * (1 + P[5] * (1 + P[6] * (1 + P[7])))))))),
    ...
    p.fromGregorianDate = function (e, t) {
      ...
      var n,
          ...
          w = u[0],
          g = u[1];
      if (null !== (u = w.match(N))) n = +u[1], s = +u[2], l = +u[3];else if (null !== (u = w.match(R))) n = +u[1], s = +u[2];else if (null !== (u = w.match(T))) n = +u[1];else {
        var C;
        if (null !== (u = w.match(A))) n = +u[1], C = +u[2], a = o(n);else if (null !== (u = w.match(S))) {
          n = +u[1];
          var x = +u[2],
              U = +u[3] || 0,
    ...
    return p.toGregorianDate = function (e, t) {
      ...
      return y += 12, y > 23 && (y -= 24), n && (A += 1), r(t) ? (t.year = m, t.month = _, t.day = E, t.hour = y, t.minute = R, t.second = A, t.millisecond = S, t.isLeapSecond = n, t) : new a(m, _, E, y, R, A, S, n);
    }, p.toDate = function (e) {
    ...
    return h.maximumRequests = 50, h.maximumRequestsPerServer = 6, h.requestsByServer = {
      ...
      for (var o = Math.max(h.maximumRequests - I.length, 0), u = 0; u < o && N.length > 0;) {
        t = N.pop(), t.cancelled ? T(t) : !t.throttleByServer || E(t.serverKey) ? (y(t), ++u) : T(t);
      }
    ...
    function U(e) {
      ...
      if (u(o)) return o.otherwise(function (e) {
        return a.state !== N.FAILED ? t.reject(e) : n.retryOnError(e).then(function (o) {
          return o ? (a.state = N.UNISSUED, a.deferred = void 0, U({
            resource: n,
            flipY: r,
            preferImageBitmap: i
          })) : t.reject(e);
    ...
    function P(e, n, r) {
      ...
      if (u(o)) return o.otherwise(function (i) {
        return a.state !== N.FAILED ? t.reject(i) : e.retryOnError(i).then(function (o) {
          return o ? (a.state = N.UNISSUED, a.deferred = void 0, P(e, n, r)) : t.reject(i);
        });
      });
    }
    ...
    x.supportsImageBitmapOptions = function () {
      ...
      var n = o(e.preferImageBitmap, !1),
          r = o(e.preferBlob, !1),
          i = o(e.flipY, !1);
      if (g(this.request), !q || this.isDataUri || this.isBlobUri || !this.hasHeaders && !r) return U({
        resource: this,
        flipY: i,
        preferImageBitmap: n
      });
      ...
      if (u(i)) return i.then(function (e) {
        ...
        return r.state !== N.FAILED ? t.reject(i) : n.retryOnError(i).then(function (a) {
          return a ? (r.state = N.UNISSUED, r.deferred = void 0, n.fetch(e)) : t.reject(i);
        });
      });
    };
    var V = /^data:(.*?)(;base64)?,(.*)$/;
    ...
    A.localFrameToFixedFrameGenerator = function (e, t) {
      ...
      return u(I[a]) ? r = I[a] : (r = function r(_r, a, s) {
        if (u(s) || (s = new y()), _.equalsEpsilon(_r.x, 0, _.EPSILON14) && _.equalsEpsilon(_r.y, 0, _.EPSILON14)) {
          ...
          n.unpack(N[e], 0, v), "east" !== e && "west" !== e && n.multiplyByScalar(v, c, v), n.unpack(N[t], 0, M), "east" !== t && "west" !== t && n.multiplyByScalar(M, c, M), n.unpack(N[i], 0, w), "east" !== i && "west" !== i && n.multiplyByScalar(w, c, w);
        } else {
          a = o(a, f.WGS84), a.geodeticSurfaceNormal(_r, O.up);
          var l = O.up,
              h = O.east;
          h.x = -_r.y, h.y = _r.x, h.z = 0, n.normalize(h, O.east), n.cross(l, h, O.north), n.multiplyByScalar(O.up, -1, O.down), n.multiplyByScalar(O.east, -1, O.west), n.multiplyByScalar(O.north, -1, O.south), v = O[e], M = O[t], w = O[i];
        }

        return s[0] = v.x, s[1] = v.y, s[2] = v.z, s[3] = 0, s[4] = M.x, s[5] = M.y, s[6] = M.z, s[7] = 0, s[8] = w.x, s[9] = w.y, s[10] = w.z, s[11] = 0, s[12] = _r.x, s[13] = _r.y, s[14] = _r.z, s[15] = 1, s;
      }, I[a] = r), r;
      ...
      if (u(n)) {
        ...
        if (u(a)) {
          ...
          var C = -47e-6 * g * _.RADIANS_PER_DEGREE / 3600,
              ...
              U = Math.sin(C),
              P = H;
          return P[0] = O * x, P[1] = O * U, P[2] = M, P[3] = -v * U + w * M * x, P[4] = v * x + w * M * U, P[5] = -w * O, P[6] = -w * U - v * M * x, P[7] = w * x - v * M * U, P[8] = v * O, m.multiply(I, P, t);
        }
      }
    };
    ...
    return _._textureCoordinateRotationPoints = function (r, i, a, o) {
      ...
      for (u = 0; u < 3; u++) {
        n.toCartesian(g[u], a, C), C = f.multiplyByPointAsVector(M, C, C), w[u].x = C.x, w[u].y = C.y;
      }
      ...
      for (u = 0; u < P; u++) {
        C = f.multiplyByPointAsVector(M, r[u], C), C = l.multiplyByVector(U, C, C), D = Math.min(D, C.x), F = Math.min(F, C.y), L = Math.max(L, C.x), b = Math.max(b, C.y);
      }
  ...
  }), define("Core/CylinderGeometry", ["./arrayFill", "./BoundingSphere", "./Cartesian2", "./Cartesian3", "./ComponentDatatype", "./CylinderGeometryLibrary", "./defaultValue", "./defined", "./DeveloperError", "./Geometry", "./GeometryAttribute", "./GeometryAttributes", "./GeometryOffsetAttribute", "./IndexDatatype", "./Math", "./PrimitiveType", "./VertexFormat"], function (e, t, n, r, i, a, o, u, s, c, l, f, h, d, E, p, _) {
    "use strict";
    ...
    function m(e) {
      ...
      var t = e.length,
          ...
          a = o(e.slices, 128);
      this._length = t, this._topRadius = n, this._bottomRadius = r, this._vertexFormat = _.clone(i), this._slices = a, this._offsetAttribute = e.offsetAttribute, this._workerName = "createCylinderGeometry";
    }
    ...
    var y = new n(),
        ...
        A = new r(),
        S = new r();
    m.packedLength = _.packedLength + 5, m.pack = function (e, t, n) {
      return n = o(n, 0), _.pack(e._vertexFormat, t, n), n += _.packedLength, t[n++] = e._length, t[n++] = e._topRadius, t[n++] = e._bottomRadius, t[n++] = e._slices, t[n] = o(e._offsetAttribute, -1), t;
    };
    var N = new _(),
        I = {
      vertexFormat: N,
    ...
    m.unpack = function (e, t, n) {
      ...
      var i = e[t++],
          ...
          c = e[t++],
          l = e[t];
      return u(n) ? (n._vertexFormat = _.clone(r, n._vertexFormat), n._length = i, n._topRadius = a, n._bottomRadius = s, n._slices = c, n._offsetAttribute = -1 === l ? void 0 : l, n) : (I.length = i, I.topRadius = a, I.bottomRadius = s, I.slices = c, I.offsetAttribute = -1 === l ? void 0 : l, new m(I));
      ...
      if (!(s <= 0 || _ < 0 || m < 0 || 0 === _ && 0 === m)) {
        ...
        if (D) {
          ...
          for (O = 0; O < I; O++) {
            var W = O / I * E.TWO_PI,
                H = G * Math.cos(W),
                Y = G * Math.sin(W);
            D && (q.x = H, q.y = Y, F && (V = r.normalize(r.cross(r.UNIT_Z, q, V), V)), N.normal && (x[L++] = q.x, x[L++] = q.y, x[L++] = q.z, x[L++] = q.x, x[L++] = q.y, x[L++] = q.z), N.tangent && (U[b++] = V.x, U[b++] = V.y, U[b++] = V.z, U[b++] = V.x, U[b++] = V.y, U[b++] = V.z), N.bitangent && (X = r.normalize(r.cross(q, V, X), X), P[B++] = X.x, P[B++] = X.y, P[B++] = X.z, P[B++] = X.x, P[B++] = X.y, P[B++] = X.z));
          }

          for (O = 0; O < I; O++) {
            N.normal && (x[L++] = 0, x[L++] = 0, x[L++] = -1), N.tangent && (U[b++] = 1, U[b++] = 0, U[b++] = 0), N.bitangent && (P[B++] = 0, P[B++] = -1, P[B++] = 0);
          }
        ...
        for (j[K++] = v - 2, j[K++] = 0, j[K++] = 1, j[K++] = v - 2, j[K++] = 1, j[K++] = v - 1, O = 1; O < I - 1; O++) {
        ...
        var ee = new f();
        N.position && (ee.position = new l({
          componentDatatype: i.DOUBLE,
          componentsPerAttribute: 3,
          values: g
        })), N.normal && (ee.normal = new l({
          componentDatatype: i.FLOAT,
          componentsPerAttribute: 3,
          values: x
        })), N.tangent && (ee.tangent = new l({
          componentDatatype: i.FLOAT,
          componentsPerAttribute: 3,
          values: U
        })), N.bitangent && (ee.bitangent = new l({
          componentDatatype: i.FLOAT,
          componentsPerAttribute: 3,
          values: P
        })), N.st && (ee.st = new l({
    ...
    var O;
    return m.getUnitCylinder = function () {
      return u(O) || (O = m.createGeometry(new m({
        topRadius: 1,
        bottomRadius: 1,
        length: 1,
  ...
  }), define("Workers/createCylinderGeometry", ["../Core/CylinderGeometry", "../Core/defined"], function (e, t) {
    "use strict";
