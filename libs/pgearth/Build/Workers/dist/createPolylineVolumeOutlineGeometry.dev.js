...
!function () {
  define("Core/defined", [], function () {
    ...
    function i(n, i, u, s, c) {
      ...
      do {
        b -= B, w = 1 / (1 + b * A), N = 1 / (1 + b * g), x = 1 / (1 + b * S), C = w * w, P = N * N, U = x * x, D = C * w, L = P * N, F = U * x, M = m * C + y * P + _ * U - 1, I = m * D * A + y * L * g + _ * F * S;
        B = M / (-2 * I);
      } while (Math.abs(M) > r.EPSILON12);

      return t(c) ? (c.x = l * w, c.y = f * N, c.z = h * x, c) : new e(l * w, f * N, h * x);
    }
    ...
    l.packedLength = 16, l.pack = function (e, t, n) {
      ...
      return r[0] = T * a, r[1] = A * a, r[2] = O * a, r[3] = 0, r[4] = R * o, r[5] = g * o, r[6] = M * o, r[7] = 0, r[8] = v * u, r[9] = S * u, r[10] = I * u, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, r;
    ...
    l.getMaximumScale = function (t) {
      ...
      var r = e[0],
          ...
          Z = a * C + c * P + d * U + y * D,
          K = o * C + l * P + p * U + _ * D;
      return n[0] = L, n[1] = F, n[2] = b, n[3] = B, n[4] = q, n[5] = z, n[6] = G, n[7] = V, n[8] = W, n[9] = X, n[10] = H, n[11] = Y, n[12] = k, n[13] = j, n[14] = Z, n[15] = K, n;
      ...
      var r = e[0],
          ...
          b = i * S + u * O + l * M + d,
          B = a * S + s * O + f * M + p;
      return n[0] = I, n[1] = w, n[2] = N, n[3] = 0, n[4] = x, n[5] = C, n[6] = P, n[7] = 0, n[8] = U, n[9] = D, n[10] = L, n[11] = 0, n[12] = F, n[13] = b, n[14] = B, n[15] = 1, n;
      ...
      var r = e[0],
          ...
          w = i * _ + u * T + l * R,
          N = a * _ + s * T + f * R;
      return n[0] = v, n[1] = A, n[2] = g, n[3] = 0, n[4] = S, n[5] = O, n[6] = M, n[7] = 0, n[8] = I, n[9] = w, n[10] = N, n[11] = 0, n[12] = e[12], n[13] = e[13], n[14] = e[14], n[15] = e[15], n;
    ...
    return l.inverse = function (e, n) {
      ...
      I = a * p, w = o * d, N = i * p, x = o * h, C = i * d, P = a * h, U = r * p, D = o * f, L = r * d, F = a * f, b = r * h, B = i * f;
      ...
      return te = 1 / te, n[0] = q * te, n[1] = z * te, n[2] = G * te, n[3] = V * te, n[4] = W * te, n[5] = X * te, n[6] = H * te, n[7] = Y * te, n[8] = k * te, n[9] = j * te, n[10] = Z * te, n[11] = K * te, n[12] = J * te, n[13] = Q * te, n[14] = $ * te, n[15] = ee * te, n;
    ...
    d.fromPoints = function (t, n) {
      ...
      for (r = 1; r < h; r++) {
        ...
        var M = a.x,
            I = a.y,
            w = a.z;
        M < o.x && e.clone(a, o), M > c.x && e.clone(a, c), I < u.y && e.clone(a, u), I > l.y && e.clone(a, l), w < s.z && e.clone(a, s), w > f.z && e.clone(a, f);
      }
    ...
    d.fromRectangle2D = function (e, t, n) {
      ...
      n = r(n, I), h.southwest(t, x), x.height = a, h.northeast(t, C), C.height = o;
      var s = n.project(x, w),
          c = n.project(C, N),
          l = c.x - s.x,
          f = c.y - s.y,
    ...
    d.fromRectangle3D = function (t, n, o, u) {
      ...
      for (s = 0; s < w; s += a) {
        var N = t[s] + n.x,
            x = t[s + 1] + n.y,
            C = t[s + 2] + n.z;
        u.x = N, u.y = x, u.z = C, N < c.x && e.clone(u, c), N > h.x && e.clone(u, h), x < l.y && e.clone(u, l), x > M.y && e.clone(u, M), C < f.z && e.clone(u, f), C > I.z && e.clone(u, I);
      }
      ...
      return z < X ? (e.clone(B, o.center), o.radius = z) : (e.clone(W, o.center), o.radius = X), o;
      ...
      for (o = 0; o < M; o += 3) {
        var I = t[o] + n[o],
            w = t[o + 1] + n[o + 1],
            N = t[o + 2] + n[o + 2];
        a.x = I, a.y = w, a.z = N, I < u.x && e.clone(a, u), I > l.x && e.clone(a, l), w < s.y && e.clone(a, s), w > f.y && e.clone(a, f), N < c.z && e.clone(a, c), N > h.z && e.clone(a, h);
      }
      ...
      return B < V ? (e.clone(F, r.center), r.radius = B) : (e.clone(G, r.center), r.radius = V), r;
    ...
    for (var N = new s(), x = 1.9011074535173003, C = i.supportsTypedArrays() ? new Float32Array(8) : [], P = i.supportsTypedArrays() ? new Float32Array(8) : [], U = i.supportsTypedArrays() ? new Float32Array(8) : [], D = i.supportsTypedArrays() ? new Float32Array(8) : [], L = 0; L < 7; ++L) {
      var F = L + 1,
          b = 2 * F + 1;
      C[L] = 1 / (F * b), P[L] = F / b;
    }
    ...
    E.fromGregorianDate = function (e, t) {
      ...
      if (r(N)) {
        u = N.match(I), null !== u ? (h = +u[1], m = +u[2], _ = +u[3], S = 1e3 * +(u[4] || 0), D = 5) : (u = N.match(M), null !== u ? (h = +u[1], m = +u[2], _ = 60 * +(u[3] || 0), D = 4) : null !== (u = N.match(O)) && (h = +u[1], m = 60 * +(u[2] || 0), D = 3));
        var L = u[D],
            F = +u[D + 1],
            b = +(u[D + 2] || 0);
      ...
      return r(t) ? (d(q[0], q[1], t), f(t)) : t = new E(q[0], q[1], c.UTC), B && E.addSeconds(t, 1, t), t;
    }, E.now = function (e) {
    ...
    function m(e) {
      return function (t) {
        e.state !== l.CANCELLED && (--v.numberOfActiveRequests, --O[e.serverKey], I.raiseEvent(), e.state = l.RECEIVED, e.deferred.resolve(t));
      };
    }

    function y(e) {
      return function (t) {
        e.state !== l.CANCELLED && (++v.numberOfFailedRequests, --v.numberOfActiveRequests, --O[e.serverKey], I.raiseEvent(t), e.state = l.FAILED, e.deferred.reject(t));
      };
    }
    ...
    C.supportsImageBitmapOptions = function () {
      ...
      var n = o(e.preferImageBitmap, !1),
          r = o(e.preferBlob, !1),
          i = o(e.flipY, !1);
      if (N(this.request), !z || this.isDataUri || this.isBlobUri || !this.hasHeaders && !r) return P({
        resource: this,
        flipY: i,
        preferImageBitmap: n
      });
    ...
    v.localFrameToFixedFrameGenerator = function (e, t) {
      ...
      return u(S[a]) ? r = S[a] : (r = function r(_r, a, s) {
        if (u(s) || (s = new _()), m.equalsEpsilon(_r.x, 0, m.EPSILON14) && m.equalsEpsilon(_r.y, 0, m.EPSILON14)) {
          var c = m.sign(_r.z);
          n.unpack(g[e], 0, M), "east" !== e && "west" !== e && n.multiplyByScalar(M, c, M), n.unpack(g[t], 0, I), "east" !== t && "west" !== t && n.multiplyByScalar(I, c, I), n.unpack(g[i], 0, w), "east" !== i && "west" !== i && n.multiplyByScalar(w, c, w);
        } else {
          a = o(a, f.WGS84), a.geodeticSurfaceNormal(_r, O.up);
          var l = O.up,
              h = O.east;
          h.x = -_r.y, h.y = _r.x, h.z = 0, n.normalize(h, O.east), n.cross(l, h, O.north), n.multiplyByScalar(O.up, -1, O.down), n.multiplyByScalar(O.east, -1, O.west), n.multiplyByScalar(O.north, -1, O.south), M = O[e], I = O[t], w = O[i];
        }

        return s[0] = M.x, s[1] = M.y, s[2] = M.z, s[3] = 0, s[4] = I.x, s[5] = I.y, s[6] = I.z, s[7] = 0, s[8] = w.x, s[9] = w.y, s[10] = w.z, s[11] = 0, s[12] = _r.x, s[13] = _r.y, s[14] = _r.z, s[15] = 1, s;
      }, S[a] = r), r;
      ...
      if (u(n)) {
        ...
        if (u(a)) {
          ...
          var x = -47e-6 * N * m.RADIANS_PER_DEGREE / 3600,
              ...
              P = Math.sin(x),
              U = H;
          return U[0] = O * C, U[1] = O * P, U[2] = I, U[3] = -M * P + w * I * C, U[4] = M * C + w * I * P, U[5] = -w * O, U[6] = -w * P - M * I * C, U[7] = w * C - M * I * P, U[8] = M * O, y.multiply(S, U, t);
        }
      }
    };
    ...
    return m._textureCoordinateRotationPoints = function (r, i, a, o) {
      ...
      for (u = 0; u < 3; u++) {
        n.toCartesian(N[u], a, x), x = f.multiplyByPointAsVector(I, x, x), w[u].x = x.x, w[u].y = x.y;
      }
      ...
      for (u = 0; u < U; u++) {
        x = f.multiplyByPointAsVector(I, r[u], x), x = l.multiplyByVector(P, x, x), D = Math.min(D, x.x), L = Math.min(L, x.y), F = Math.max(F, x.x), b = Math.max(b, x.y);
      }
      ...
      for (u = 0; u < 3; u++) {
        var W = q[u];
        c.multiplyByVector(B, W, W), W.x = (W.x - z.x) / G, W.y = (W.y - z.y) / V;
      }
    ...
    y.computeSubdivision = function (e, t, r, i) {
      ...
      for (var O = [], M = {}, I = e.maximumRadius, w = h.chordLength(i, I), N = w * w; c.length > 0;) {
        var x,
            C,
            P = c.pop(),
            U = c.pop(),
    ...
    return y.computeRhumbLineSubdivision = function (e, t, r, i) {
      ...
      for (var A = [], g = {}, N = e.maximumRadius, x = h.chordLength(i, N), C = new c(void 0, void 0, e), P = new c(void 0, void 0, e), U = new c(void 0, void 0, e); p.length > 0;) {
        var D = p.pop(),
            L = p.pop(),
            F = p.pop(),
    ...
    function n(e, t, n, r) {
      ...
      var D = i * (-U / 2 - C * Math.sin(P)),
          ...
          F = o,
          b = L / F;
      P = Math.abs(Math.atan2(c * x, -N) / 3), i = 2 * Math.sqrt(-w), U = Math.cos(P), a = i * U, D = i * (-U / 2 - C * Math.sin(P));
      var B = -c,
          q = a + D < 2 * s ? a + s : D + s,
          z = B / q,
          G = F * q,
    ...
    function a(t, i, a, o) {
      ...
      if (d.length > 0) {
        ...
        var I, w;
        0 === T && 0 === p ? (I = 0, w = 0) : n.sign(T) === n.sign(p) ? (I = T + p, w = m / I) : (w = T - p, I = m / w);
        var N, x;
        0 === R && 0 === E ? (N = 0, x = 0) : n.sign(R) === n.sign(E) ? (N = R + E, x = o / N) : (x = R - E, N = o / x);
    ...
    function p(t, n, r, i, a) {
      ...
      for (var D = 0; D < U; ++D) {
        var L,
            ...
            B = Math.max(1 - b, 0),
            q = Math.sqrt(B);
        L = o.sign(p) === o.sign(m) ? d(p * b + m, E * F, o.EPSILON12) : o.sign(m) === o.sign(E * F) ? d(p * b, E * F + m, o.EPSILON12) : d(p * b + E * F, m, o.EPSILON12);
    ...
    E.grazingAltitudeLocation = function (t, n) {
      ...
      if (V > 0) {
        for (var W = e.clone(e.ZERO, q), X = Number.NEGATIVE_INFINITY, H = 0; H < V; ++H) {
        ...
        return X = o.clamp(X, 0, 1), A = e.magnitude(e.subtract(W, i, N)) * Math.sqrt(1 - X * X), A = c ? -A : A, j.height = A, n.cartographicToCartesian(j, new e());
      }
    };
    ...
    function f(e, t, n, r, i, a, o) {
      ...
      do {
        ...
        var C;
        0 === f ? (C = 0, h = 1) : (C = A * N / f, h = 1 - C * C), I = M, d = c - 2 * S / h, isNaN(d) && (d = 0), M = E + l(p, C, h, s, f, c, d);
    ...
    return a(d.prototype, {
      ...
      return i(n) ? (n.longitude = this._start.longitude + N, n.latitude = A, n.height = 0, n) : new t(this._start.longitude + N, A, 0);
    }, d;
    ...
    function p(t, n, r, i, a, o, u, s) {
      ...
      for (var R = 1; R < f; R++) {
        ...
        v.height = E[R], T = i.cartographicToCartesian(v, N), e.pack(T, u, _), _ += 3;
      }
    ...
    function E(t, n, r, i, a, o, s, c) {
      ...
      for (var v = 1; v < E; v++) {
        ...
        A.height = y[v], R = i.cartographicToCartesian(A, N), e.pack(R, s, T), T += 3;
      }
        ...
        for (var y = a[0], M = t.length, I = 1; I < M; ++I) {
          ...
          if (h.getPointDistance(E, y) < 0 || h.getPointDistance(E, w) < 0) {
            ...
            if (r(N)) {
              ...
              h.getPointDistance(d, y) < 0 && e.negate(x, x), a.push(e.add(N, x, new e())), o.push(m + 1), e.negate(x, x), a.push(e.add(N, x, new e())), m = 1;
            }
          }
    ...
    function E(e, n, r, i, a, o, c, l) {
      var h = G,
          d = V;
      b = f.eastNorthUpToFixedFrame(e, a, b), h = s.multiplyByPointAsVector(b, F, h), h = t.normalize(h, h);
      var E = p(h, n, e, a);
      q = u.fromRotationZ(E, q), W.z = o, b = s.multiplyTransformation(b, s.fromRotationTranslation(q, W, B), b);
      var m = z;
      m[0] = c;

      for (var y = 0; y < l; y++) {
        for (var _ = 0; _ < r.length; _ += 3) {
          d = t.fromArray(r, _, d), d = u.multiplyByVector(m, d, d), d = s.multiplyByPoint(b, d, d), i.push(d.x, d.y, d.z);
        }
      }
    ...
    return P.computePositions = function (e, n, r, a, u) {
      var s = a._ellipsoid,
          ...
          K = e[0],
          J = e[1];
      V = s.geodeticSurfaceNormal(K, V), q = t.subtract(J, K, q), q = t.normalize(q, q), Y = t.cross(V, q, Y), Y = t.normalize(Y, Y);
      var Q = l[0],
          $ = l[1];
      u && (B = E(K, Y, U, B, s, Q + D, 1, 1)), k = t.clone(K, k), K = J, z = t.negate(q, z);

      for (var ee, te, ne = 1; ne < F - 1; ne++) {
        var re = u ? 2 : 1;
        J = e[ne + 1], q = t.subtract(J, K, q), q = t.normalize(q, q), G = t.add(q, z, G), G = t.normalize(G, G), V = s.geodeticSurfaceNormal(K, V);
        ...
        if (!o.equalsEpsilon(Math.abs(t.dot(ie, ae)), 1, o.EPSILON7)) {
          ...
          var oe = 1 / Math.max(.25, t.magnitude(t.cross(G, z, x))),
          ...
          ue ? (W = t.add(K, t.multiplyByScalar(G, oe * L, G), W), X = t.add(W, t.multiplyByScalar(Y, L, X), X), R[0] = t.clone(k, R[0]), R[1] = t.clone(X, R[1]), ee = d(R, Q + D, $ + D, f), te = c.generateArc({
            ...
            granularity: f,
            ellipsoid: s
          }), b = m(te, Y, C, b, s, ee, 1), Y = t.cross(V, q, Y), Y = t.normalize(Y, Y), H = t.add(W, t.multiplyByScalar(Y, L, H), H), p === i.ROUNDED || p === i.BEVELED ? T(W, X, H, p, ue, s, b, C, $ + D, u) : (G = t.negate(G, G), b = E(K, G, C, b, s, $ + D, oe, re)), k = t.clone(H, k)) : (W = t.add(K, t.multiplyByScalar(G, oe * L, G), W), X = t.add(W, t.multiplyByScalar(Y, -L, X), X), R[0] = t.clone(k, R[0]), R[1] = t.clone(X, R[1]), ee = d(R, Q + D, $ + D, f), te = c.generateArc({
            positions: R,
            granularity: f,
            ellipsoid: s
          }), b = m(te, Y, C, b, s, ee, 1), Y = t.cross(V, q, Y), Y = t.normalize(Y, Y), H = t.add(W, t.multiplyByScalar(Y, -L, H), H), p === i.ROUNDED || p === i.BEVELED ? T(W, X, H, p, ue, s, b, C, $ + D, u) : b = E(K, G, C, b, s, $ + D, oe, re), k = t.clone(H, k)), z = t.negate(q, z);
      ...
      R[0] = t.clone(k, R[0]), R[1] = t.clone(K, R[1]), ee = d(R, Q + D, $ + D, f), te = c.generateArc({
        ...
        granularity: f,
        ellipsoid: s
      }), b = m(te, Y, C, b, s, ee, 1), u && (B = E(K, Y, U, B, s, $ + D, 1, 1)), F = b.length;
      var se = u ? F + B.length : F,
          ce = new Float64Array(se);
      return ce.set(b), u && ce.set(B, F), ce;
    }, P;
  }), define("Core/PolylineVolumeOutlineGeometry", ["./arrayRemoveDuplicates", "./BoundingRectangle", "./BoundingSphere", "./Cartesian2", "./Cartesian3", "./ComponentDatatype", "./CornerType", "./defaultValue", "./defined", "./DeveloperError", "./Ellipsoid", "./Geometry", "./GeometryAttribute", "./GeometryAttributes", "./IndexDatatype", "./Math", "./PolygonPipeline", "./PolylineVolumeGeometryLibrary", "./PrimitiveType", "./WindingOrder"], function (e, t, n, r, i, a, o, u, s, c, l, f, h, d, p, E, m, y, _, T) {
    "use strict";
    ...
    function v(e) {
      ...
      var t = e.polylinePositions,
          n = e.shapePositions;
      this._positions = t, this._shape = n, this._ellipsoid = l.clone(u(e.ellipsoid, l.WGS84)), this._cornerType = u(e.cornerType, o.ROUNDED), this._granularity = u(e.granularity, E.RADIANS_PER_DEGREE), this._workerName = "createPolylineVolumeOutlineGeometry";
    ...
    v.pack = function (e, t, n) {
      ...
      return l.pack(e._ellipsoid, t, n), n += l.packedLength, t[n++] = e._cornerType, t[n] = e._granularity, t;
    };
    ...
    v.unpack = function (e, t, n) {
      ...
      var d = e[t++],
          p = e[t];
      return s(n) ? (n._positions = c, n._shape = f, n._ellipsoid = l.clone(h, n._ellipsoid), n._cornerType = d, n._granularity = p, n) : (g.polylinePositions = c, g.shapePositions = f, g.cornerType = d, g.granularity = p, new v(g));
    };

    var S = new t();
    return v.createGeometry = function (n) {
      var r = n._positions,
  ...
  }), define("Workers/createPolylineVolumeOutlineGeometry", ["../Core/defined", "../Core/Ellipsoid", "../Core/PolylineVolumeOutlineGeometry"], function (e, t, n) {
    "use strict";
