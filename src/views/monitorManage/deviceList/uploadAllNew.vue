...
<script>
import { upLoadDeviceDataNew,upLoadDeviceDataNew1,upLoadDeviceDataNew2 } from "@/api/monitorManage/quxian";
        ...
        pickerOptions: {
          shortcuts: [{
            ...
            onClick(picker) {
              ...
              // formatDate(new Date().getTime() - 1*86400000,"yyyy-MM-dd hh:mm:ss")
