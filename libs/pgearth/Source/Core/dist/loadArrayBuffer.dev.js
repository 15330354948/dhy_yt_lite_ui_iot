...
define(['./Check', './defined', './deprecationWarning', './Resource'], function (Check, defined, deprecationWarning, Resource) {
  'use strict';
  /**
  ...
  function loadArrayBuffer(urlOrResource, headers, request) {
    ...
    Check.defined('urlOrResource', urlOrResource); //>>includeEnd('debug');
