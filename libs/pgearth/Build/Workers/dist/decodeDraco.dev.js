...
!function () {
  define("Core/defined", [], function () {
    ...
    return r(n, {
      ...
      t = !1;
      var r = document.body;
      if ("function" == typeof r.requestFullscreen) return E.requestFullscreen = "requestFullscreen", E.exitFullscreen = "exitFullscreen", E.fullscreenEnabled = "fullscreenEnabled", E.fullscreenElement = "fullscreenElement", E.fullscreenchange = "fullscreenchange", E.fullscreenerror = "fullscreenerror", t = !0;

      for (var n, _ = ["webkit", "moz", "o", "ms", "khtml"], T = 0, R = _.length; T < R; ++T) {
        var A = _[T];
        n = A + "RequestFullscreen", "function" == typeof r[n] ? (E.requestFullscreen = n, t = !0) : (n = A + "RequestFullScreen", "function" == typeof r[n] && (E.requestFullscreen = n, t = !0)), n = A + "ExitFullscreen", "function" == typeof document[n] ? E.exitFullscreen = n : (n = A + "CancelFullScreen", "function" == typeof document[n] && (E.exitFullscreen = n)), n = A + "FullscreenEnabled", void 0 !== document[n] ? E.fullscreenEnabled = n : (n = A + "FullScreenEnabled", void 0 !== document[n] && (E.fullscreenEnabled = n)), n = A + "FullscreenElement", void 0 !== document[n] ? E.fullscreenElement = n : (n = A + "FullScreenElement", void 0 !== document[n] && (E.fullscreenElement = n)), n = A + "fullscreenchange", void 0 !== document["on" + n] && ("ms" === A && (n = "MSFullscreenChange"), E.fullscreenchange = n), n = A + "fullscreenerror", void 0 !== document["on" + n] && ("ms" === A && (n = "MSFullscreenError"), E.fullscreenerror = n);
      }

      return t;
    }, n.requestFullscreen = function (e, r) {
      n.supportsFullscreen() && e[E.requestFullscreen]({
        vrDisplay: r
      });
    ...
    e("ThirdParty/when", [], function () {
      ...
      function r(e) {
        var r, t;
        return e instanceof E ? r = e : R(e) ? (t = T(), e.then(function (e) {
          t.resolve(e);
        }, function (e) {
          t.reject(e);
        }, function (e) {
      ...
      function T() {
        ...
        return o = new E(e), A = {
        ...
        }, i = [], u = [], a = function a(e, r, t) {
          var E, n;
          return E = T(), n = "function" == typeof t ? function (e) {
            try {
              E.progress(t(e));
            } catch (e) {
              E.progress(e);
          ...
          return e = r(e), a = e.then, _I = r, N = c, s(i, e), u = i = F, e;
        }, A;
      }
      ...
      function A(r, t, E, n, _) {
        return S(2, arguments), e(r, function (r) {
          function R(e) {
            _s(e);
          }
          ...
          var o, i, u, a, N, _I2, _s, S, O, f;

          if (O = r.length >>> 0, o = Math.max(0, Math.min(t, O)), u = [], i = O - o + 1, a = [], N = T(), o) for (S = N.progress, _s = function s(e) {
            a.push(e), --i || (_I2 = _s = c, N.reject(a));
          }, _I2 = function I(e) {
            u.push(e), --o || (_I2 = _s = c, N.resolve(u));
          }, f = 0; f < O; ++f) {
            f in r && e(r[f], A, R, S);
          } else N.resolve(u);
          return N.then(E, n, _);
      ...
      function a(r, t) {
        return e(r, function (r) {
          ...
          if (_ = n = r.length >>> 0, E = [], o = T(), _) for (R = function R(r, n) {
      ...
      function N(r, t) {
        ...
        return e(r, function (r) {
          var n;
          return n = r.length, E[0] = function (r, E, _) {
            return e(r, function (r) {
      ...
      function S(e, r) {
        for (var t, E = r.length; E > e;) {
          if (null != (t = r[--E]) && "function" != typeof t) throw new Error("arg " + E + " must be a function");
        }
      }
      ...
      var f, M, F;
      return e.defer = T, e.resolve = r, e.reject = t, e.join = u, e.all = i, e.map = a, e.reduce = N, e.any = o, e.some = A, e.chain = I, e.isPromise = R, E.prototype = {
      ...
      }, M = [].slice, f = [].reduce || function (e) {
        var r, t, E, n, _;

        if (_ = 0, r = Object(this), n = r.length >>> 0, t = arguments, t.length <= 1) for (;;) {
          if (_ in r) {
            E = r[_++];
            break;
          }
  ...
  }), define("Core/FeatureDetection", ["./defaultValue", "./defined", "./defineProperties", "./DeveloperError", "./Fullscreen", "../ThirdParty/when"], function (e, r, t, E, n, _) {
    "use strict";
    ...
    function N() {
      if (!r(G)) {
        G = !1;
        var e;
        "Microsoft Internet Explorer" === D.appName ? null !== (e = /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(D.userAgent)) && (G = !0, p = T(e[1])) : "Netscape" === D.appName && null !== (e = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(D.userAgent)) && (G = !0, p = T(e[1]));
      }
    ...
    function M() {
      return r(H) || (H = !c() && "undefined" != typeof PointerEvent && (!r(D.pointerEnabled) || D.pointerEnabled)), H;
    }
    ...
    C._promise = void 0, C._result = void 0, C.initialize = function () {
      ...
      if (C._promise = e.promise, s()) return C._result = !1, e.resolve(C._result), e.promise;
      var t = new Image();
    ...
    var b = [];
    "undefined" != typeof ArrayBuffer && (b.push(Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array), "undefined" != typeof Uint8ClampedArray && b.push(Uint8ClampedArray), "undefined" != typeof CanvasPixelArray && b.push(CanvasPixelArray));
    var Y = {
      isChrome: R,
      chromeVersion: A,
      isSafari: o,
    ...
    return Y.supportsFullscreen = function () {
  ...
  }), define("Core/ComponentDatatype", ["./defaultValue", "./defined", "./DeveloperError", "./FeatureDetection", "./freezeObject", "./WebGLConstants"], function (e, r, t, E, n, _) {
    "use strict";
    ...
    return T.getSizeInBytes = function (e) {
      switch (e) {
        case T.BYTE:
      ...
      return e instanceof Int8Array ? T.BYTE : e instanceof Uint8Array ? T.UNSIGNED_BYTE : e instanceof Int16Array ? T.SHORT : e instanceof Uint16Array ? T.UNSIGNED_SHORT : e instanceof Int32Array ? T.INT : e instanceof Uint32Array ? T.UNSIGNED_INT : e instanceof Float32Array ? T.FLOAT : e instanceof Float64Array ? T.DOUBLE : void 0;
    }, T.validate = function (e) {
      return r(e) && (e === T.BYTE || e === T.UNSIGNED_BYTE || e === T.SHORT || e === T.UNSIGNED_SHORT || e === T.INT || e === T.UNSIGNED_INT || e === T.FLOAT || e === T.DOUBLE);
      ...
      switch (E = e(E, 0), n = e(n, (t.byteLength - E) / T.getSizeInBytes(r)), r) {
        case T.BYTE:
    ...
    var n = {};
    return n.typeOf = {}, n.defined = function (E, n) {
      if (!e(n)) throw new r(t(E));
    }, n.typeOf.func = function (e, t) {
      if ("function" != typeof t) throw new r(E(_typeof(t), "function", e));
    }, n.typeOf.string = function (e, t) {
      if ("string" != typeof t) throw new r(E(_typeof(t), "string", e));
    }, n.typeOf.number = function (e, t) {
      if ("number" != typeof t) throw new r(E(_typeof(t), "number", e));
    }, n.typeOf.number.lessThan = function (e, t, E) {
      if (n.typeOf.number(e, t), t >= E) throw new r("Expected " + e + " to be less than " + E + ", actual value was " + t);
    }, n.typeOf.number.lessThanOrEquals = function (e, t, E) {
      if (n.typeOf.number(e, t), t > E) throw new r("Expected " + e + " to be less than or equal to " + E + ", actual value was " + t);
    }, n.typeOf.number.greaterThan = function (e, t, E) {
      if (n.typeOf.number(e, t), t <= E) throw new r("Expected " + e + " to be greater than " + E + ", actual value was " + t);
    }, n.typeOf.number.greaterThanOrEquals = function (e, t, E) {
      if (n.typeOf.number(e, t), t < E) throw new r("Expected " + e + " to be greater than or equal to" + E + ", actual value was " + t);
    }, n.typeOf.object = function (e, t) {
      if ("object" != _typeof(t)) throw new r(E(_typeof(t), "object", e));
    }, n.typeOf.bool = function (e, t) {
      if ("boolean" != typeof t) throw new r(E(_typeof(t), "boolean", e));
    }, n.typeOf.number.equals = function (e, t, E, _) {
      if (n.typeOf.number(e, E), n.typeOf.number(t, _), E !== _) throw new r(e + " must be equal to " + t + ", the actual values are " + E + " and " + _);
    }, n;
  }), define("Core/Math", ["../ThirdParty/mersenne-twister", "./Check", "./defaultValue", "./defined", "./DeveloperError"], function (e, r, t, E, n) {
    "use strict";

    var _ = {};
    _.EPSILON1 = .1, _.EPSILON2 = .01, _.EPSILON3 = .001, _.EPSILON4 = 1e-4, _.EPSILON5 = 1e-5, _.EPSILON6 = 1e-6, _.EPSILON7 = 1e-7, _.EPSILON8 = 1e-8, _.EPSILON9 = 1e-9, _.EPSILON10 = 1e-10, _.EPSILON11 = 1e-11, _.EPSILON12 = 1e-12, _.EPSILON13 = 1e-13, _.EPSILON14 = 1e-14, _.EPSILON15 = 1e-15, _.EPSILON16 = 1e-16, _.EPSILON17 = 1e-17, _.EPSILON18 = 1e-18, _.EPSILON19 = 1e-19, _.EPSILON20 = 1e-20, _.EPSILON21 = 1e-21, _.GRAVITATIONALPARAMETER = 3986004418e5, _.SOLAR_RADIUS = 6955e5, _.LUNAR_RADIUS = 1737400, _.SIXTY_FOUR_KILOBYTES = 65536, _.sign = t(Math.sign, function (e) {
      return e = +e, 0 === e || e !== e ? e : e > 0 ? 1 : -1;
    }), _.signNotZero = function (e) {
      return e < 0 ? -1 : 1;
    }, _.toSNorm = function (e, r) {
      return r = t(r, 255), Math.round((.5 * _.clamp(e, -1, 1) + .5) * r);
      ...
      return (1 - t) * e + t * r;
    }, _.PI = Math.PI, _.ONE_OVER_PI = 1 / Math.PI, _.PI_OVER_TWO = Math.PI / 2, _.PI_OVER_THREE = Math.PI / 3, _.PI_OVER_FOUR = Math.PI / 4, _.PI_OVER_SIX = Math.PI / 6, _.THREE_PI_OVER_TWO = 3 * Math.PI / 2, _.TWO_PI = 2 * Math.PI, _.ONE_OVER_TWO_PI = 1 / (2 * Math.PI), _.RADIANS_PER_DEGREE = Math.PI / 180, _.DEGREES_PER_RADIAN = 180 / Math.PI, _.RADIANS_PER_ARCSECOND = _.RADIANS_PER_DEGREE / 3600, _.toRadians = function (e) {
    ...
    _.factorial = function (e) {
      var r = T.length;
      if (e >= r) for (var t = T[r - 1], E = r; E <= e; E++) {
        T.push(t * E);
      }
      return T[e];
    ...
    var R = new e();
    return _.setRandomNumberSeed = function (r) {
      R = new e(r);
      ...
      var T = t / E;
      return n = _.fastApproximateAtan(T), n = Math.abs(r) > Math.abs(e) ? _.PI_OVER_TWO - n : n, n = e < 0 ? _.PI - n : n, n = r < 0 ? -n : n;
    }, _;
  }), define("Core/IndexDatatype", ["./defined", "./DeveloperError", "./freezeObject", "./Math", "./WebGLConstants"], function (e, r, t, E, n) {
    "use strict";
    ...
    return _.getSizeInBytes = function (e) {
      switch (e) {
      ...
      return e(r) && (r === _.UNSIGNED_BYTE || r === _.UNSIGNED_SHORT || r === _.UNSIGNED_INT);
      ...
      return e >= E.SIXTY_FOUR_KILOBYTES ? new Uint32Array(r, t, n) : new Uint16Array(r, t, n);
    }, t(_);
    ...
    return r;
  }), define("Workers/createTaskProcessorWorker", ["../ThirdParty/when", "../Core/defaultValue", "../Core/defined", "../Core/formatError"], function (e, r, t, E) {
    "use strict";
    ...
    function _(_) {
      ...
      return function (R) {
        ...
        return e(n(_, A.parameters, o)).then(function (e) {
          i.result = e;
        }).otherwise(function (e) {
          e instanceof Error ? i.error = {
            name: e.name,
            message: e.message,
            stack: e.stack
          } : i.error = e;
        }).always(function () {
          t(T) || (T = r(self.webkitPostMessage, self.postMessage)), A.canTransferArrayBuffer || (o.length = 0);

          try {
            T(i, o);
          } catch (e) {
            i.result = void 0, i.error = "postMessage failed with error: " + E(e) + "\n  with responseMessage: " + JSON.stringify(i), T(i);
          }
        });
      };
    }
    ...
    return _;
  }), define("Workers/decodeDraco", ["../Core/ComponentDatatype", "../Core/defined", "../Core/IndexDatatype", "../Core/RuntimeError", "./createTaskProcessorWorker"], function (e, r, t, E, n) {
    "use strict";

    function _(e, r) {
      for (var E = e.num_points(), n = e.num_faces(), _ = new I.DracoInt32Array(), T = 3 * n, R = t.createTypedArray(E, T), A = 0, o = 0; o < n; ++o) {
        r.GetFaceFromMesh(e, o, _), R[A + 0] = _.GetValue(0), R[A + 1] = _.GetValue(1), R[A + 2] = _.GetValue(2), A += 3;
      }
    ...
    function T(e, r, t, E, n) {
      ...
      E.quantizationBits <= 8 ? (T = new I.DracoUInt8Array(), _ = new Uint8Array(n), r.GetAttributeUInt8ForAllPoints(e, t, T)) : (T = new I.DracoUInt16Array(), _ = new Uint16Array(n), r.GetAttributeUInt16ForAllPoints(e, t, T));
    ...
    function R(e, r, t, E) {
      ...
      switch (t.data_type()) {
        case 1:
        case 11:
          _ = new I.DracoInt8Array(), n = new Int8Array(E), r.GetAttributeInt8ForAllPoints(e, t, _);
          break;

        case 2:
          _ = new I.DracoUInt8Array(), n = new Uint8Array(E), r.GetAttributeUInt8ForAllPoints(e, t, _);
          break;

        case 3:
          _ = new I.DracoInt16Array(), n = new Int16Array(E), r.GetAttributeInt16ForAllPoints(e, t, _);
          break;

        case 4:
          _ = new I.DracoUInt16Array(), n = new Uint16Array(E), r.GetAttributeUInt16ForAllPoints(e, t, _);
          break;

        case 5:
        case 7:
          _ = new I.DracoInt32Array(), n = new Int32Array(E), r.GetAttributeInt32ForAllPoints(e, t, _);
          break;

        case 6:
        case 8:
          _ = new I.DracoUInt32Array(), n = new Uint32Array(E), r.GetAttributeUInt32ForAllPoints(e, t, _);
          break;

        case 9:
        case 10:
          _ = new I.DracoFloat32Array(), n = new Float32Array(E), r.GetAttributeFloatForAllPoints(e, t, _);
      }
    ...
    function A(t, E, n) {
      ...
      if (i.InitFromAttribute(n)) {
        for (var u = new Array(o), a = 0; a < o; ++a) {
          u[a] = i.min_value(a);
        }
      ...
      I.destroy(i), i = new I.AttributeOctahedronTransform(), i.InitFromAttribute(n) && (_ = {
        quantizationBits: i.quantization_bits(),
        octEncoded: !0
      }), I.destroy(i);
      var N,
    ...
    function o(e) {
      var r = new I.Decoder();
      e.dequantizeInShader && (r.SkipAttributeTransform(I.POSITION), r.SkipAttributeTransform(I.NORMAL));
      var t = new I.DecoderBuffer();
      if (t.Init(e.buffer, e.buffer.length), r.GetEncodedGeometryType(t) !== I.POINT_CLOUD) throw new E("Draco geometry type must be POINT_CLOUD.");

      var n = new I.PointCloud(),
          _ = r.DecodeBufferToPointCloud(t, n);

      if (!_.ok() || 0 === n.ptr) throw new E("Error decoding draco point cloud: " + _.error_msg());
      I.destroy(t);
      var T = {},
          R = e.properties;
    ...
    function i(e) {
      ...
      if (e.dequantizeInShader) for (var n = 0; n < t.length; ++n) {
        r.SkipAttributeTransform(I[t[n]]);
      }
      var T = e.bufferView,
          R = new I.DecoderBuffer();
      if (R.Init(e.array, T.byteLength), r.GetEncodedGeometryType(R) !== I.TRIANGULAR_MESH) throw new E("Unsupported draco mesh geometry type.");
      var o = new I.Mesh(),
          i = r.DecodeBufferToMesh(R, o);
      if (!i.ok() || 0 === o.ptr) throw new E("Error decoding draco mesh geometry: " + i.error_msg());
      I.destroy(R);
      var u = {},
    ...
    function N(e) {
      ...
      if (r(E)) return require([E.modulePath], function (e) {
        r(E.wasmBinaryFile) ? (r(e) || (e = self.DracoDecoderModule), e(E).then(function (e) {
          a(e);
        })) : a(e());
      });
    }
