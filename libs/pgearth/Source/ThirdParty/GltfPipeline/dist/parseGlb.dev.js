...
define(['./addPipelineExtras', './removeExtensionsUsed', '../../Core/defaultValue', '../../Core/defined', '../../Core/getMagic', '../../Core/getStringFromTypedArray', '../../Core/RuntimeError'], function (addPipelineExtras, removeExtensionsUsed, defaultValue, defined, getMagic, getStringFromTypedArray, RuntimeError) {
  'use strict';
  ...
  function parseGlbVersion1(glb, header) {
    ...
    contentString = contentString.replace(/CESIUM/g, 'PGEARTH');
  ...
  function parseGlbVersion2(glb, header) {
    ...
    while (byteOffset < length) {
      ...
      if (chunkType === 0x4E4F534A) {
        ...
        jsonString = jsonString.replace(/CESIUM/g, 'PGEARTH');
