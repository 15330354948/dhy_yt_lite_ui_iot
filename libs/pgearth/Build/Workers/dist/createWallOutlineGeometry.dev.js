...
!function () {
  define("Core/defined", [], function () {
    ...
    function i(n, i, u, s, c) {
      ...
      do {
        b -= B, N = 1 / (1 + b * A), w = 1 / (1 + b * g), x = 1 / (1 + b * S), C = N * N, P = w * w, U = x * x, D = C * N, L = P * w, F = U * x, I = m * C + _ * P + y * U - 1, M = m * D * A + _ * L * g + y * F * S;
        B = I / (-2 * M);
      } while (Math.abs(I) > r.EPSILON12);

      return t(c) ? (c.x = l * N, c.y = f * w, c.z = h * x, c) : new e(l * N, f * w, h * x);
    }
    ...
    s.packedLength = 9, s.pack = function (e, t, r) {
      ...
      return r(t) ? (t[0] = p, t[1] = _, t[2] = R, t[3] = E, t[4] = y, t[5] = v, t[6] = m, t[7] = T, t[8] = A, t) : new s(p, E, m, _, y, T, R, v, A);
    ...
    l.packedLength = 16, l.pack = function (e, t, n) {
      ...
      return r[0] = T * a, r[1] = A * a, r[2] = O * a, r[3] = 0, r[4] = R * o, r[5] = g * o, r[6] = I * o, r[7] = 0, r[8] = v * u, r[9] = S * u, r[10] = M * u, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, r;
    ...
    l.getMaximumScale = function (t) {
      ...
      var r = e[0],
          ...
          b = i * S + u * O + l * I + d,
          B = a * S + s * O + f * I + p;
      return n[0] = M, n[1] = N, n[2] = w, n[3] = 0, n[4] = x, n[5] = C, n[6] = P, n[7] = 0, n[8] = U, n[9] = D, n[10] = L, n[11] = 0, n[12] = F, n[13] = b, n[14] = B, n[15] = 1, n;
      ...
      var r = e[0],
          ...
          N = i * y + u * T + l * R,
          w = a * y + s * T + f * R;
      return n[0] = v, n[1] = A, n[2] = g, n[3] = 0, n[4] = S, n[5] = O, n[6] = I, n[7] = 0, n[8] = M, n[9] = N, n[10] = w, n[11] = 0, n[12] = e[12], n[13] = e[13], n[14] = e[14], n[15] = e[15], n;
    ...
    return l.inverse = function (e, n) {
      ...
      M = a * p, N = o * d, w = i * p, x = o * h, C = i * d, P = a * h, U = r * p, D = o * f, L = r * d, F = a * f, b = r * h, B = i * f;
    ...
    d.fromPoints = function (t, n) {
      ...
      for (r = 1; r < h; r++) {
        ...
        var I = a.x,
            M = a.y,
            N = a.z;
        I < o.x && e.clone(a, o), I > c.x && e.clone(a, c), M < u.y && e.clone(a, u), M > l.y && e.clone(a, l), N < s.z && e.clone(a, s), N > f.z && e.clone(a, f);
      }
    ...
    d.fromRectangle2D = function (e, t, n) {
      ...
      n = r(n, M), h.southwest(t, x), x.height = a, h.northeast(t, C), C.height = o;
      var s = n.project(x, N),
          c = n.project(C, w),
          l = c.x - s.x,
          f = c.y - s.y,
    ...
    d.fromRectangle3D = function (t, n, o, u) {
      ...
      for (s = 0; s < N; s += a) {
        var w = t[s] + n.x,
            x = t[s + 1] + n.y,
            C = t[s + 2] + n.z;
        u.x = w, u.y = x, u.z = C, w < c.x && e.clone(u, c), w > h.x && e.clone(u, h), x < l.y && e.clone(u, l), x > I.y && e.clone(u, I), C < f.z && e.clone(u, f), C > M.z && e.clone(u, M);
      }
      ...
      for (o = 0; o < I; o += 3) {
        var M = t[o] + n[o],
            N = t[o + 1] + n[o + 1],
            w = t[o + 2] + n[o + 2];
        a.x = M, a.y = N, a.z = w, M < u.x && e.clone(a, u), M > l.x && e.clone(a, l), N < s.y && e.clone(a, s), N > f.y && e.clone(a, f), w < c.z && e.clone(a, c), w > h.z && e.clone(a, h);
      }
    ...
    e("ThirdParty/when", [], function () {
      ...
      function o() {
        ...
        return c = new r(e), s = {
          ...
          return e = t(e), h = e.then, _p = t, d = _, E(l, e), f = l = v, e;
        }, s;
      }
    ...
    E.fromGregorianDate = function (e, t) {
      ...
      var n,
          ...
          N = u[0],
          w = u[1];
      if (null !== (u = N.match(g))) n = +u[1], s = +u[2], l = +u[3];else if (null !== (u = N.match(R))) n = +u[1], s = +u[2];else if (null !== (u = N.match(T))) n = +u[1];else {
        var x;
        if (null !== (u = N.match(v))) n = +u[1], x = +u[2], a = o(n);else if (null !== (u = N.match(A))) {
          n = +u[1];
          var C = +u[2],
              P = +u[3] || 0,
      ...
      if (r(w)) {
        u = w.match(M), null !== u ? (h = +u[1], m = +u[2], y = +u[3], S = 1e3 * +(u[4] || 0), D = 5) : (u = w.match(I), null !== u ? (h = +u[1], m = +u[2], y = 60 * +(u[3] || 0), D = 4) : null !== (u = w.match(O)) && (h = +u[1], m = 60 * +(u[2] || 0), D = 3));
        var L = u[D],
            F = +u[D + 1],
            b = +(u[D + 2] || 0);
    ...
    return E.toGregorianDate = function (e, t) {
      ...
      return y += 12, y > 23 && (y -= 24), n && (v += 1), r(t) ? (t.year = _, t.month = m, t.day = p, t.hour = y, t.minute = R, t.second = v, t.millisecond = A, t.isLeapSecond = n, t) : new a(_, m, p, y, R, v, A, n);
    }, E.toDate = function (e) {
    ...
    function m(e) {
      return function (t) {
        e.state !== l.CANCELLED && (--v.numberOfActiveRequests, --O[e.serverKey], M.raiseEvent(), e.state = l.RECEIVED, e.deferred.resolve(t));
      };
    }

    function _(e) {
      return function (t) {
        e.state !== l.CANCELLED && (++v.numberOfFailedRequests, --v.numberOfActiveRequests, --O[e.serverKey], M.raiseEvent(t), e.state = l.FAILED, e.deferred.reject(t));
      };
    }

    function y(e) {
      var t = E(e);
      return e.state = l.ACTIVE, S.push(e), ++v.numberOfActiveRequests, ++v.numberOfActiveRequestsEver, ++O[e.serverKey], e.requestFunction().then(m(e)).otherwise(_(e)), t;
    }
    ...
    function C(t) {
      t = o(t, o.EMPTY_OBJECT), "string" == typeof t && (t = {
        url: t
      }), this._url = void 0, this._templateValues = N(t.templateValues, {}), this._queryParameters = N(t.queryParameters, {}), this.headers = N(t.headers, {}), this.request = o(t.request, new R()), this.proxy = t.proxy, this.retryCallback = t.retryCallback, this.retryAttempts = o(t.retryAttempts, 0), this._retryCount = 0;
      var n = new e(t.url);
    ...
    function p(e, n) {
      ...
      for (var y, T = e._addNewLeapSeconds, R = 0, v = m.length; R < v; R += e._columnCount) {
        var A = m[R + i],
            g = m[R + E],
    ...
    v.localFrameToFixedFrameGenerator = function (e, t) {
      ...
      return u(S[a]) ? r = S[a] : (r = function r(_r, a, s) {
        if (u(s) || (s = new y()), m.equalsEpsilon(_r.x, 0, m.EPSILON14) && m.equalsEpsilon(_r.y, 0, m.EPSILON14)) {
          var c = m.sign(_r.z);
          n.unpack(g[e], 0, I), "east" !== e && "west" !== e && n.multiplyByScalar(I, c, I), n.unpack(g[t], 0, M), "east" !== t && "west" !== t && n.multiplyByScalar(M, c, M), n.unpack(g[i], 0, N), "east" !== i && "west" !== i && n.multiplyByScalar(N, c, N);
        } else {
          a = o(a, f.WGS84), a.geodeticSurfaceNormal(_r, O.up);
          var l = O.up,
              h = O.east;
          h.x = -_r.y, h.y = _r.x, h.z = 0, n.normalize(h, O.east), n.cross(l, h, O.north), n.multiplyByScalar(O.up, -1, O.down), n.multiplyByScalar(O.east, -1, O.west), n.multiplyByScalar(O.north, -1, O.south), I = O[e], M = O[t], N = O[i];
        }

        return s[0] = I.x, s[1] = I.y, s[2] = I.z, s[3] = 0, s[4] = M.x, s[5] = M.y, s[6] = M.z, s[7] = 0, s[8] = N.x, s[9] = N.y, s[10] = N.z, s[11] = 0, s[12] = _r.x, s[13] = _r.y, s[14] = _r.z, s[15] = 1, s;
      }, S[a] = r), r;
      ...
      if (u(n)) {
        ...
        if (u(a)) {
          ...
          var x = -47e-6 * w * m.RADIANS_PER_DEGREE / 3600,
              ...
              P = Math.sin(x),
              U = H;
          return U[0] = O * C, U[1] = O * P, U[2] = M, U[3] = -I * P + N * M * C, U[4] = I * C + N * M * P, U[5] = -N * O, U[6] = -N * P - I * M * C, U[7] = N * C - I * M * P, U[8] = I * O, _.multiply(S, U, t);
        }
      }
    };
    ...
    return m._textureCoordinateRotationPoints = function (r, i, a, o) {
      ...
      for (u = 0; u < 3; u++) {
        n.toCartesian(w[u], a, x), x = f.multiplyByPointAsVector(M, x, x), N[u].x = x.x, N[u].y = x.y;
      }
      ...
      for (u = 0; u < U; u++) {
        x = f.multiplyByPointAsVector(M, r[u], x), x = l.multiplyByVector(P, x, x), D = Math.min(D, x.x), L = Math.min(L, x.y), F = Math.max(F, x.x), b = Math.max(b, x.y);
      }
    ...
    function n(e, t, n, r) {
      ...
      var D = i * (-U / 2 - C * Math.sin(P)),
          ...
          F = o,
          b = L / F;
      P = Math.abs(Math.atan2(c * x, -w) / 3), i = 2 * Math.sqrt(-N), U = Math.cos(P), a = i * U, D = i * (-U / 2 - C * Math.sin(P));
      var B = -c,
          q = a + D < 2 * s ? a + s : D + s,
          z = B / q,
          G = F * q,
    ...
    function a(t, i, a, o) {
      ...
      if (d.length > 0) {
        ...
        var M, N;
        0 === T && 0 === p ? (M = 0, N = 0) : n.sign(T) === n.sign(p) ? (M = T + p, N = m / M) : (N = T - p, M = m / N);
        var w, x;
        0 === R && 0 === E ? (w = 0, x = 0) : n.sign(R) === n.sign(E) ? (w = R + E, x = o / w) : (x = R - E, w = o / x);
    ...
    function e(e, n, i) {
      ...
      if (a && (u = s(e, n, u, i)), e.length > 80 * i) {
        ...
        for (var _ = i; _ < o; _ += i) {
          p = e[_], E = e[_ + 1], p < l && (l = p), E < f && (f = E), p > h && (h = p), E > d && (d = E);
        }
    ...
    function r(e, t, s, c, l, f, d) {
      if (e) {
        ...
        for (var p, E, m = e; e.prev !== e.next;) {
          if (p = e.prev, E = e.next, f ? a(e, c, l, f) : i(e)) t.push(p.i / s), t.push(e.i / s), t.push(E.i / s), I(e), e = E.next, m = E.next;else if ((e = E) === m) {
    ...
    function i(e) {
      ...
      for (var i = e.next.next; i !== e.prev;) {
        if (m(t.x, t.y, n.x, n.y, r.x, r.y, i.x, i.y) && y(i.prev, i, i.next) >= 0) return !1;
        i = i.next;
      }
    ...
    function a(e, t, n, r) {
      ...
      for (var u = i.x < a.x ? i.x < o.x ? i.x : o.x : a.x < o.x ? a.x : o.x, s = i.y < a.y ? i.y < o.y ? i.y : o.y : a.y < o.y ? a.y : o.y, c = i.x > a.x ? i.x > o.x ? i.x : o.x : a.x > o.x ? a.x : o.x, l = i.y > a.y ? i.y > o.y ? i.y : o.y : a.y > o.y ? a.y : o.y, f = p(u, s, t, n, r), h = p(c, l, t, n, r), d = e.nextZ; d && d.z <= h;) {
        if (d !== e.prev && d !== e.next && m(i.x, i.y, a.x, a.y, o.x, o.y, d.x, d.y) && y(d.prev, d, d.next) >= 0) return !1;
        d = d.nextZ;
      }
    ...
    _.computeSubdivision = function (e, t, r, i) {
      ...
      for (var O = [], I = {}, M = e.maximumRadius, N = h.chordLength(i, M), w = N * N; c.length > 0;) {
        var x,
            C,
            P = c.pop(),
            U = c.pop(),
    ...
    function s(e) {
      var t = e._uSquared,
          ...
          v = 1 - 3 * E + 35 * m / 4,
          A = 1 - 5 * E,
          g = T * l - R * Math.sin(2 * l) * E / 2 - v * Math.sin(4 * l) * m / 16 - A * Math.sin(6 * l) * _ / 48 - 5 * Math.sin(8 * l) * y / 512,
          S = e._constants;

      S.a = n, S.b = r, S.f = i, S.cosineHeading = a, S.sineHeading = o, S.tanU = u, S.cosineU = s, S.sineU = c, S.sigma = l, S.sineAlpha = f, S.sineSquaredAlpha = h, S.cosineSquaredAlpha = d, S.cosineAlpha = p, S.u2Over4 = E, S.u4Over16 = m, S.u6Over64 = _, S.u8Over256 = y, S.a0 = T, S.a1 = R, S.a2 = v, S.a3 = A, S.distanceRatio = g;
    }
    ...
    function f(e, t, n, r, i, a, o) {
      ...
      do {
        ...
        var C;
        0 === f ? (C = 0, h = 1) : (C = A * w / f, h = 1 - C * C), M = I, d = c - 2 * S / h, isNaN(d) && (d = 0), I = E + l(p, C, h, s, f, c, d);
    ...
    function p(t, n, r, i, a, o, u, s) {
      ...
      for (var R = 1; R < f; R++) {
        ...
        v.height = E[R], T = i.cartographicToCartesian(v, w), e.pack(T, u, y), y += 3;
      }
    ...
    m.wrapLongitude = function (t, i) {
        ...
        for (var _ = a[0], I = t.length, M = 1; M < I; ++M) {
          ...
          if (h.getPointDistance(E, _) < 0 || h.getPointDistance(E, N) < 0) {
            ...
            if (r(w)) {
              ...
              h.getPointDistance(d, _) < 0 && e.negate(x, x), a.push(e.add(w, x, new e())), o.push(m + 1), e.negate(x, x), a.push(e.add(w, x, new e())), m = 1;
            }
          }
      ...
      for (y = 0; y < o - 1; y++) {
        T += m.numberOfPoints(i[y], i[y + 1], E);
      }
    ...
    return m.generateRhumbArc = function (i) {
      ...
      for (_ = 0; _ < u - 1; _++) {
        y = s.cartesianToCartographic(o[_ + 1], L), R += m.numberOfPointsRhumbLine(v, y, T), v = t.clone(y, D);
      }
    ...
    function s(n, r, i, a) {
      ...
      if (!(o < 2)) {
        ...
        c && (_.height = i[0]), h = h && _.height <= 0, p[0] = _.height, E[0] = s ? a[0] : 0;

        for (var y = 1, T = 1; T < o; ++T) {
          var R = r[T],
              v = n.cartesianToCartographic(R, f);
          c && (v.height = i[T]), h = h && v.height <= 0, u(_, v) ? _.height < v.height && (p[y - 1] = v.height) : (d[y] = R, p[y] = v.height, E[y] = s ? a[T] : 0, e.clone(v, _), ++y);
        }

        if (!(h || y < 2)) return d.length = y, p.length = y, E.length = y, {
          positions: d,
          topHeights: p,
          bottomHeights: E
        };
    ...
    return c.computePositions = function (e, u, c, l, f, E) {
      var m = s(e, u, c, l);

      if (t(m)) {
        if (u = m.positions, c = m.topHeights, l = m.bottomHeights, u.length >= 3) {
        ...
        if (S.minDistance = g, S.ellipsoid = e, E) {
          ...
          for (O = 0; O < v - 1; O++) {
            ...
            T.set(x, w), N[0] = l[O], N[1] = l[O + 1], R.set(a.generateArc(S), w), w += x.length;
          }
  ...
  }), define("Core/WallOutlineGeometry", ["./BoundingSphere", "./Cartesian3", "./ComponentDatatype", "./defaultValue", "./defined", "./DeveloperError", "./Ellipsoid", "./Geometry", "./GeometryAttribute", "./GeometryAttributes", "./IndexDatatype", "./Math", "./PrimitiveType", "./WallGeometryLibrary"], function (e, t, n, r, i, a, o, u, s, c, l, f, h, d) {
    "use strict";
    ...
    function p(e) {
      ...
      this._positions = n, this._minimumHeights = u, this._maximumHeights = a, this._granularity = s, this._ellipsoid = o.clone(c), this._workerName = "createWallOutlineGeometry";
      var l = 1 + n.length * t.packedLength + 2;
      i(u) && (l += u.length), i(a) && (l += a.length), this.packedLength = l + o.packedLength + 1;
    }
    ...
    return p.unpack = function (e, n, a) {
      n = r(n, 0);
      var u,
          s = e[n++],
          c = new Array(s);
      ...
      n += o.packedLength;
      var d = e[n];
      return i(a) ? (a._positions = c, a._minimumHeights = l, a._maximumHeights = f, a._ellipsoid = o.clone(h, a._ellipsoid), a._granularity = d, a) : (y.positions = c, y.minimumHeights = l, y.maximumHeights = f, y.granularity = d, new p(y));
      ...
      if (i(T)) {
        ...
        for (I = 0; I < A; ++I) {
          var M = 3 * I,
              N = t.fromArray(v, M, E),
              w = t.fromArray(R, M, m);
          S[O++] = w.x, S[O++] = w.y, S[O++] = w.z, S[O++] = N.x, S[O++] = N.y, S[O++] = N.z;
        }
        ...
        for (I = 0; I < C - 2; I += 2) {
          ...
          if (!t.equalsEpsilon(F, b, f.EPSILON10)) {
            var B = I + 1,
                q = I + 3;
            P[U++] = B, P[U++] = D, P[U++] = B, P[U++] = q, P[U++] = D, P[U++] = L;
          }
        }

        return P[U++] = C - 2, P[U++] = C - 1, new u({
          attributes: x,
          indices: P,
  ...
  }), define("Workers/createWallOutlineGeometry", ["../Core/defined", "../Core/Ellipsoid", "../Core/WallOutlineGeometry"], function (e, t, n) {
    "use strict";
