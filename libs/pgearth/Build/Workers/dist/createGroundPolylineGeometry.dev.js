...
!function () {
  define("Core/defined", [], function () {
    ...
    e("ThirdParty/when", [], function () {
      ...
      function o() {
        ...
        return c = new r(e), s = {
          ...
          return e = t(e), h = e.then, _p = t, d = _, E(l, e), f = l = A, e;
        }, s;
      }
      ...
      function s(t, n, r, i, a) {
        return m(2, arguments), e(t, function (t) {
          ...
          var c, l, f, h, d, _p2, _E, m, y, T;

          if (y = t.length >>> 0, c = Math.max(0, Math.min(n, y)), f = [], l = y - c + 1, h = [], d = o(), c) for (m = d.progress, _E = function E(e) {
            h.push(e), --l || (_p2 = _E = _, d.reject(h));
          }, _p2 = function p(e) {
            f.push(e), --c || (_p2 = _E = _, d.resolve(f));
          }, T = 0; T < y; ++T) {
            T in t && e(t[T], s, u, m);
          } else d.resolve(f);
          return d.then(r, i, a);
    ...
    function m(e) {
      return function (t) {
        e.state !== l.CANCELLED && (--A.numberOfActiveRequests, --O[e.serverKey], I.raiseEvent(), e.state = l.RECEIVED, e.deferred.resolve(t));
      };
    }

    function _(e) {
      return function (t) {
        e.state !== l.CANCELLED && (++A.numberOfFailedRequests, --A.numberOfActiveRequests, --O[e.serverKey], I.raiseEvent(t), e.state = l.FAILED, e.deferred.reject(t));
      };
    }

    function y(e) {
      var t = E(e);
      return e.state = l.ACTIVE, S.push(e), ++A.numberOfActiveRequests, ++A.numberOfActiveRequestsEver, ++O[e.serverKey], e.requestFunction().then(m(e)).otherwise(_(e)), t;
    }

    function T(e) {
      var t = e.state === l.ACTIVE;
      e.state = l.CANCELLED, ++A.numberOfCancelledRequests, e.deferred.reject(), t && (--A.numberOfActiveRequests, --O[e.serverKey], ++A.numberOfCancelledActiveRequests), i(e.cancelFunction) && e.cancelFunction();
    }
    ...
    return h.maximumRequests = 50, h.maximumRequestsPerServer = 6, h.requestsByServer = {
      ...
      S.length = 0, O = {}, A.numberOfAttemptedRequests = 0, A.numberOfActiveRequests = 0, A.numberOfCancelledRequests = 0, A.numberOfCancelledActiveRequests = 0, A.numberOfFailedRequests = 0, A.numberOfActiveRequestsEver = 0, A.lastNumberOfActiveRequests = 0;
    ...
    function x(e) {
      ...
      if (u(o)) return o.otherwise(function (e) {
        return a.state !== g.FAILED ? t.reject(e) : n.retryOnError(e).then(function (o) {
          return o ? (a.state = g.UNISSUED, a.deferred = void 0, x({
            resource: n,
            flipY: r,
            preferImageBitmap: i
          })) : t.reject(e);
    ...
    function U(e, n, r) {
      ...
      a.url = e.url, a.requestFunction = function () {
        ...
        }, P._Implementations.loadAndExecuteScript(e.url, r, n), n.promise;
      };
      var o = v.request(a);
    ...
    P.supportsImageBitmapOptions = function () {
      ...
      var n = o(e.preferImageBitmap, !1),
          r = o(e.preferBlob, !1),
          i = o(e.flipY, !1);
      if (N(this.request), !z || this.isDataUri || this.isBlobUri || !this.hasHeaders && !r) return x({
        resource: this,
        flipY: i,
        preferImageBitmap: n
      });
    ...
    }, P._Implementations = {}, P._Implementations.createImage = function (e, t, n, r, i) {
      P.supportsImageBitmapOptions().then(function (r) {
        return r && i ? P.fetchBlob({
          url: e
        }) : void b(e, t, n);
      }).then(function (e) {
        if (u(e)) return P.createImageBitmapFromBlob(e, {
          flipY: r,
          premultiplyAlpha: !1
        });
      }).then(function (e) {
    ...
    return P._Implementations.loadWithXhr = function (e, t, n, r, i, a, o) {
      var s = V.exec(e);
    ...
    function i(n, i, u, s, c) {
      ...
      do {
        b -= B, w = 1 / (1 + b * v), N = 1 / (1 + b * g), C = 1 / (1 + b * S), P = w * w, x = N * N, U = C * C, D = P * w, L = x * N, F = U * C, M = m * P + _ * x + y * U - 1, I = m * D * v + _ * L * g + y * F * S;
        B = M / (-2 * I);
      } while (Math.abs(M) > r.EPSILON12);

      return t(c) ? (c.x = l * w, c.y = f * N, c.z = h * C, c) : new e(l * w, f * N, h * C);
    }
    ...
    s.packedLength = 9, s.pack = function (e, t, r) {
      ...
      return r(t) ? (t[0] = p, t[1] = _, t[2] = R, t[3] = E, t[4] = y, t[5] = A, t[6] = m, t[7] = T, t[8] = v, t) : new s(p, E, m, _, y, T, R, A, v);
      ...
      return r(t) ? (t[0] = l, t[1] = d, t[2] = m, t[3] = f, t[4] = p, t[5] = _, t[6] = h, t[7] = E, t[8] = y, t) : new s(l, f, h, d, p, E, m, _, y);
    ...
    return s.computeEigenDecomposition = function (e, t) {
      ...
      for (var o = t.unitary = s.clone(s.IDENTITY, t.unitary), h = t.diagonal = s.clone(e, t.diagonal), d = n * c(h); a < 10 && l(h) > d;) {
        f(h, m), s.transpose(m, _), s.multiply(h, m, h), s.multiply(_, h, h), s.multiply(o, m, o), ++i > 2 && (++a, i = 0);
      }
    ...
    l.packedLength = 16, l.pack = function (e, t, n) {
      ...
      return r[0] = T * a, r[1] = v * a, r[2] = O * a, r[3] = 0, r[4] = R * o, r[5] = g * o, r[6] = M * o, r[7] = 0, r[8] = A * u, r[9] = S * u, r[10] = I * u, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, r;
    ...
    l.fromCamera = function (t, n) {
      ...
      var u = h.x,
          ...
          S = _ * -R + y * -A + T * -v,
          O = p * R + E * A + m * v;
      return i(n) ? (n[0] = u, n[1] = _, n[2] = -p, n[3] = 0, n[4] = s, n[5] = y, n[6] = -E, n[7] = 0, n[8] = c, n[9] = T, n[10] = -m, n[11] = 0, n[12] = g, n[13] = S, n[14] = O, n[15] = 1, n) : new l(u, s, c, g, _, y, T, S, -p, -E, -m, O, 0, 0, 0, 1);
      ...
      return i[0] = h, i[1] = 0, i[2] = 0, i[3] = 0, i[4] = 0, i[5] = d, i[6] = 0, i[7] = 0, i[8] = 0, i[9] = 0, i[10] = p, i[11] = 0, i[12] = E, i[13] = m, i[14] = _, i[15] = 1, i;
    ...
    l.getMaximumScale = function (t) {
      ...
      var r = e[0],
          ...
          Z = a * P + c * x + d * U + _ * D,
          K = o * P + l * x + p * U + y * D;
      return n[0] = L, n[1] = F, n[2] = b, n[3] = B, n[4] = q, n[5] = z, n[6] = G, n[7] = V, n[8] = W, n[9] = X, n[10] = H, n[11] = k, n[12] = Y, n[13] = j, n[14] = Z, n[15] = K, n;
      ...
      var r = e[0],
          ...
          b = i * S + u * O + l * M + d,
          B = a * S + s * O + f * M + p;
      return n[0] = I, n[1] = w, n[2] = N, n[3] = 0, n[4] = C, n[5] = P, n[6] = x, n[7] = 0, n[8] = U, n[9] = D, n[10] = L, n[11] = 0, n[12] = F, n[13] = b, n[14] = B, n[15] = 1, n;
      ...
      var r = e[0],
          ...
          w = i * y + u * T + l * R,
          N = a * y + s * T + f * R;
      return n[0] = A, n[1] = v, n[2] = g, n[3] = 0, n[4] = S, n[5] = O, n[6] = M, n[7] = 0, n[8] = I, n[9] = w, n[10] = N, n[11] = 0, n[12] = e[12], n[13] = e[13], n[14] = e[14], n[15] = e[15], n;
    ...
    return l.inverse = function (e, n) {
      ...
      I = a * p, w = o * d, N = i * p, C = o * h, P = i * d, x = a * h, U = r * p, D = o * f, L = r * d, F = a * f, b = r * h, B = i * f;
      ...
      return te = 1 / te, n[0] = q * te, n[1] = z * te, n[2] = G * te, n[3] = V * te, n[4] = W * te, n[5] = X * te, n[6] = H * te, n[7] = k * te, n[8] = Y * te, n[9] = j * te, n[10] = Z * te, n[11] = K * te, n[12] = J * te, n[13] = Q * te, n[14] = $ * te, n[15] = ee * te, n;
    ...
    d.fromPoints = function (t, n) {
      ...
      var L = v;
      L.x = .5 * (x.x + U.x), L.y = .5 * (x.y + U.y), L.z = .5 * (x.z + U.z);
    ...
    d.fromRectangle2D = function (e, t, n) {
      ...
      n = r(n, I), h.southwest(t, C), C.height = a, h.northeast(t, P), P.height = o;
      var s = n.project(C, w),
          c = n.project(P, N),
          l = c.x - s.x,
          f = c.y - s.y,
    ...
    d.fromRectangle3D = function (t, n, o, u) {
      ...
      for (s = 0; s < w; s += a) {
        var N = t[s] + n.x,
            C = t[s + 1] + n.y,
            P = t[s + 2] + n.z;
        u.x = N, u.y = C, u.z = P, N < c.x && e.clone(u, c), N > h.x && e.clone(u, h), C < l.y && e.clone(u, l), C > M.y && e.clone(u, M), P < f.z && e.clone(u, f), P > I.z && e.clone(u, I);
      }
      ...
      for (s = 0; s < w; s += a) {
        ...
        if (k > q) {
          ...
          z = .5 * (z + Y), q = z * z;
          var j = Y - z;
          B.x = (z * B.x + j * u.x) / Y, B.y = (z * B.y + j * u.y) / Y, B.z = (z * B.z + j * u.z) / Y;
        }
      }
      ...
      for (o = 0; o < M; o += 3) {
        ...
        if (X > b) {
          ...
          B = .5 * (B + H), b = B * B;
          var k = H - B;
          F.x = (B * F.x + k * a.x) / H, F.y = (B * F.y + k * a.y) / H, F.z = (B * F.z + k * a.z) / H;
        }
      }
  ...
  }), define("Core/GeographicTilingScheme", ["./Cartesian2", "./Check", "./defaultValue", "./defined", "./defineProperties", "./Ellipsoid", "./GeographicProjection", "./Math", "./Rectangle"], function (e, t, n, r, i, a, o, u, s) {
    "use strict";

    function c(e) {
      e = n(e, {}), this._ellipsoid = n(e.ellipsoid, a.WGS84), this._rectangle = n(e.rectangle, s.MAX_VALUE), this._projection = new o(this._ellipsoid), this._numberOfLevelZeroTilesX = n(e.numberOfLevelZeroTilesX, 2), this._numberOfLevelZeroTilesY = n(e.numberOfLevelZeroTilesY, 1);
    }
    ...
    return i(c.prototype, {
      ...
      return r(t) ? (t.west = n, t.south = i, t.east = a, t.north = o, t) : new s(n, i, a, o);
    }, c.prototype.tileXYToNativeRectangle = function (e, t, n, r) {
      var i = this.tileXYToRectangle(e, t, n, r);
      return i.west = u.toDegrees(i.west), i.south = u.toDegrees(i.south), i.east = u.toDegrees(i.east), i.north = u.toDegrees(i.north), i;
      ...
      var a = this._rectangle,
          ...
          d = a.north - t * h,
          p = a.north - (t + 1) * h;
      return r(i) || (i = new s(l, p, f, d)), i.west = l, i.south = p, i.east = f, i.north = d, i;
      ...
      if (s.contains(a, t)) {
        ...
        return p >= c && (p = c - 1), r(i) ? (i.x = d, i.y = p, i) : new e(d, p);
      }
    }, c;
  }), define("Core/ApproximateTerrainHeights", ["./buildModuleUrl", "./defaultValue", "./defined", "./defineProperties", "./BoundingSphere", "./Cartesian2", "./Cartesian3", "./Cartographic", "./Check", "./DeveloperError", "./Ellipsoid", "./GeographicTilingScheme", "./Rectangle", "./Resource"], function (e, t, n, r, i, a, o, u, s, c, l, f, h, d) {
    "use strict";

    function p(e) {
      u.fromRadians(e.east, e.north, 0, v[0]), u.fromRadians(e.west, e.north, 0, v[1]), u.fromRadians(e.east, e.south, 0, v[2]), u.fromRadians(e.west, e.south, 0, v[3]);
      var t,
          n = 0,
          r = 0,
          i = 0,
      ...
      for (t = 0; t <= o; ++t) {
        for (var s = !1, c = 0; c < 4; ++c) {
          var l = v[c];
          if (A.positionToTileXY(l, t, g), 0 === c) i = g.x, a = g.y;else if (i !== g.x || a !== g.y) {
            s = !0;
            break;
          }
        }
    ...
    return S.initialize = function () {
      ...
      return n(t) ? t : (t = d.fetchJson(e("Assets/approximateTerrainHeights.json")).then(function (e) {
        S._terrainHeights = e;
      }), S._initPromise = t, t);
      ...
      if (n(i)) {
        ...
        n(c) && (a = c[0], u = c[1]), r.cartographicToCartesian(h.northeast(e, _), E), r.cartographicToCartesian(h.southwest(e, _), m), o.midpoint(m, E, y);
      ...
      return a = Math.max(S._defaultMinTerrainHeight, a), {
        minimumTerrainHeight: a,
        maximumTerrainHeight: u
      };
    ...
    }, S._terrainHeightsMaxLevel = 6, S._defaultMaxTerrainHeight = 9e3, S._defaultMinTerrainHeight = -1e5, S._terrainHeights = void 0, S._initPromise = void 0, r(S, {
      initialized: {
        get: function get() {
    ...
    function d() {
      if (!t(P)) {
        P = !1;
        var e;
        "Microsoft Internet Explorer" === S.appName ? null !== (e = /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(S.userAgent)) && (P = !0, x = o(e[1])) : "Netscape" === S.appName && null !== (e = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(S.userAgent)) && (P = !0, x = o(e[1]));
      }
    ...
    function s(e) {
      var t = e._uSquared,
          ...
          A = 1 - 3 * E + 35 * m / 4,
          v = 1 - 5 * E,
          g = T * l - R * Math.sin(2 * l) * E / 2 - A * Math.sin(4 * l) * m / 16 - v * Math.sin(6 * l) * _ / 48 - 5 * Math.sin(8 * l) * y / 512,
          S = e._constants;

      S.a = n, S.b = r, S.f = i, S.cosineHeading = a, S.sineHeading = o, S.tanU = u, S.cosineU = s, S.sineU = c, S.sigma = l, S.sineAlpha = f, S.sineSquaredAlpha = h, S.cosineSquaredAlpha = d, S.cosineAlpha = p, S.u2Over4 = E, S.u4Over16 = m, S.u6Over64 = _, S.u8Over256 = y, S.a0 = T, S.a1 = R, S.a2 = A, S.a3 = v, S.distanceRatio = g;
    }
    ...
    function f(e, t, n, r, i, a, o) {
      ...
      do {
        ...
        var P;
        0 === f ? (P = 0, h = 1) : (P = v * N / f, h = 1 - P * P), I = M, d = c - 2 * S / h, isNaN(d) && (d = 0), M = E + l(p, P, h, s, f, c, d);
    ...
    return a(d.prototype, {
      ...
      var r = this._constants,
          ...
          y = r.u6Over64,
          T = r.u4Over16,
          R = 2 * E * m * o / 3 + a * (1 - _ + 7 * T / 4 - 15 * y / 4 + 579 * m / 64 - (T - 15 * y / 4 + 187 * m / 16) * o - (5 * y / 4 - 115 * m / 16) * u - 29 * m * s / 16) + (_ / 2 - T + 71 * y / 32 - 85 * m / 16) * c + (5 * T / 16 - 5 * y / 4 + 383 * m / 96) * f - p * ((y - 11 * m / 2) * c + 5 * m * f / 2) + (29 * y / 96 - 29 * m / 16) * h + 539 * m * d / 1536,
      ...
      return i(n) ? (n.longitude = this._start.longitude + N, n.latitude = v, n.height = 0, n) : new t(this._start.longitude + N, v, 0);
    }, d;
    ...
    s.packedLength = 4, s.pack = function (e, t, r) {
      ...
      for (var i = 0, a = n - t + 1; i < a; i++) {
        var o = 3 * i;
        s.unpack(e, 4 * (t + i), y), s.multiply(y, R, y), y.w < 0 && s.negate(y, y), s.computeAxis(y, m);
    ...
    for (var N = new s(), C = 1.9011074535173003, P = i.supportsTypedArrays() ? new Float32Array(8) : [], x = i.supportsTypedArrays() ? new Float32Array(8) : [], U = i.supportsTypedArrays() ? new Float32Array(8) : [], D = i.supportsTypedArrays() ? new Float32Array(8) : [], L = 0; L < 7; ++L) {
      var F = L + 1,
          b = 2 * F + 1;
      P[L] = 1 / (F * b), x[L] = F / b;
    }

    return P[7] = C / 136, x[7] = 8 * C / 17, s.fastSlerp = function (e, t, n, r) {
      var i,
          a = s.dot(e, t);
      a >= 0 ? i = 1 : (i = -1, a = -a);
    ...
    function e() {
      var e = /%%|%(\d+\$)?([-+\'#0 ]*)(\*\d+\$|\*|\d+)?(\.(\*\d+\$|\*|\d+))?([scboxXuideEfFgG])/g,
        ...
        for (var y = !1, T = "", R = !1, A = !1, v = " ", g = _s.length, S = 0; _s && S < g; S++) {
          switch (_s.charAt(S)) {
            case " ":
              T = " ";
              break;
        ...
        switch (f = f ? "*" == f ? +t[n++] : "*" == f.charAt(0) ? +t[f.slice(1, -1)] : +f : "fFeE".indexOf(h) > -1 ? 6 : "d" == h ? 0 : void 0, _ = r ? t[r.slice(0, -1)] : t[n++], h) {
          ...
          case "g":
          case "G":
            return d = +_, p = d < 0 ? "-" : T, E = ["toExponential", "toFixed", "toPrecision"]["efg".indexOf(h.toLowerCase())], m = ["toString", "toUpperCase"]["eEfFgG".indexOf(h) % 2], _ = p + Math.abs(d)[E](f), a(_, p, y, c, R)[m]();
    ...
    E.fromGregorianDate = function (e, t) {
      ...
      if (null !== (u = w.match(g))) n = +u[1], s = +u[2], l = +u[3];else if (null !== (u = w.match(R))) n = +u[1], s = +u[2];else if (null !== (u = w.match(T))) n = +u[1];else {
        var C;
        if (null !== (u = w.match(A))) n = +u[1], C = +u[2], a = o(n);else if (null !== (u = w.match(v))) {
          n = +u[1];
          var P = +u[2],
              x = +u[3] || 0,
      ...
      if (r(N)) {
        u = N.match(I), null !== u ? (h = +u[1], m = +u[2], y = +u[3], S = 1e3 * +(u[4] || 0), D = 5) : (u = N.match(M), null !== u ? (h = +u[1], m = +u[2], y = 60 * +(u[3] || 0), D = 4) : null !== (u = N.match(O)) && (h = +u[1], m = 60 * +(u[2] || 0), D = 3));
        var L = u[D],
            F = +u[D + 1],
            b = +(u[D + 2] || 0);
    ...
    return E.toGregorianDate = function (e, t) {
      ...
      return y += 12, y > 23 && (y -= 24), n && (A += 1), r(t) ? (t.year = _, t.month = m, t.day = p, t.hour = y, t.minute = R, t.second = A, t.millisecond = v, t.isLeapSecond = n, t) : new a(_, m, p, y, R, A, v, n);
    }, E.toDate = function (e) {
    ...
    return h.NONE = a({
      ...
      if (r(this._samples)) {
        ...
        if (r(u)) {
          ...
          if (d && E) return s = u, !p && h.equals(e) && ++s, l = s + 1, _(this, a, this._samples, e, s, l, n), n;
        }

        var m = t(a, e, o.compare, this._dateColumn);
        return m >= 0 ? (m < a.length - 1 && a[m + 1].equals(e) && ++m, s = m, l = m) : (l = ~m, (s = l - 1) < 0 && (s = 0)), this._lastIndex = s, _(this, a, this._samples, e, s, l, n), n;
      }
        ...
        if (!(o >= this._totalSamples)) {
          ...
          if (r(d[3 * s]) || (l(this, s / this._samplesPerXysFile | 0), h = !0), r(d[3 * f]) || (l(this, f / this._samplesPerXysFile | 0), h = !0), !h) {
            ...
            for (p = 0; p <= u; ++p) {
              ...
              T[p] *= y[p];
              var A = 3 * (s + p);
              n.x += T[p] * d[A++], n.y += T[p] * d[A++], n.s += T[p] * d[A];
            }
    ...
    A.localFrameToFixedFrameGenerator = function (e, t) {
      ...
      return u(S[a]) ? r = S[a] : (r = function r(_r, a, s) {
        if (u(s) || (s = new y()), m.equalsEpsilon(_r.x, 0, m.EPSILON14) && m.equalsEpsilon(_r.y, 0, m.EPSILON14)) {
          var c = m.sign(_r.z);
      ...
      if (u(n)) {
        ...
        if (u(a)) {
          ...
          var C = -47e-6 * N * m.RADIANS_PER_DEGREE / 3600,
              ...
              x = Math.sin(C),
              U = H;
          return U[0] = O * P, U[1] = O * x, U[2] = I, U[3] = -M * x + w * I * P, U[4] = M * P + w * I * x, U[5] = -w * O, U[6] = -w * x - M * I * P, U[7] = w * P - M * I * x, U[8] = M * O, _.multiply(S, U, t);
        }
      }
    };
    ...
    return m._textureCoordinateRotationPoints = function (r, i, a, o) {
      ...
      for (u = 0; u < 3; u++) {
        n.toCartesian(N[u], a, C), C = f.multiplyByPointAsVector(I, C, C), w[u].x = C.x, w[u].y = C.y;
      }
      ...
      for (u = 0; u < U; u++) {
        C = f.multiplyByPointAsVector(I, r[u], C), C = l.multiplyByVector(x, C, C), D = Math.min(D, C.x), L = Math.min(L, C.y), F = Math.max(F, C.x), b = Math.max(b, C.y);
      }
    ...
    function n(e, t, n, r) {
      ...
      if (_ < 0) {
        var y, T, R;
        h * f >= l * d ? (y = o, T = p, R = -2 * u * p + o * E) : (y = c, T = m, R = -c * E + 2 * s * m);
        var A = R < 0 ? -1 : 1,
      ...
      var D = i * (-U / 2 - P * Math.sin(x)),
          ...
          F = o,
          b = L / F;
      x = Math.abs(Math.atan2(c * C, -N) / 3), i = 2 * Math.sqrt(-w), U = Math.cos(x), a = i * U, D = i * (-U / 2 - P * Math.sin(x));
      var B = -c,
          q = a + D < 2 * s ? a + s : D + s,
          z = B / q,
          G = F * q,
    ...
    function a(t, i, a, o) {
      ...
      if (d.length > 0) {
        ...
        var N, C;
        0 === R && 0 === E ? (N = 0, C = 0) : n.sign(R) === n.sign(E) ? (N = R + E, C = o / N) : (C = R - E, N = o / C);
        var P = r.computeRealRoots(1, I, N),
            x = r.computeRealRoots(1, w, C);
        if (0 !== P.length) return 0 !== x.length ? P[1] <= x[0] ? [P[0], P[1], x[0], x[1]] : x[1] <= P[0] ? [x[0], x[1], P[0], P[1]] : P[0] >= x[0] && P[1] <= x[1] ? [x[0], P[0], P[1], x[1]] : x[0] >= P[0] && x[1] <= P[1] ? [P[0], x[0], x[1], P[1]] : P[0] > x[0] && P[0] < x[1] ? [x[0], P[0], x[1], P[1]] : [P[0], x[0], P[1], x[1]] : P;
    ...
    E.grazingAltitudeLocation = function (t, n) {
      ...
      if (V > 0) {
        ...
        return X = o.clamp(X, 0, 1), v = e.magnitude(e.subtract(W, i, N)) * Math.sqrt(1 - X * X), v = c ? -v : v, j.height = v, n.cartographicToCartesian(j, new e());
      }
    };
  ...
  }), define("Core/GroundPolylineGeometry", ["./ApproximateTerrainHeights", "./ArcType", "./arrayRemoveDuplicates", "./BoundingSphere", "./Cartesian3", "./Cartographic", "./Check", "./ComponentDatatype", "./DeveloperError", "./Math", "./defaultValue", "./defined", "./defineProperties", "./Ellipsoid", "./EllipsoidGeodesic", "./EllipsoidRhumbLine", "./EncodedCartesian3", "./GeographicProjection", "./Geometry", "./GeometryAttribute", "./IntersectionTests", "./Matrix3", "./Plane", "./Quaternion", "./Rectangle", "./WebMercatorProjection"], function (e, t, n, r, i, a, o, u, s, c, l, f, h, d, p, E, m, _, y, T, R, A, v, g, S, O) {
    "use strict";

    function M(e) {
      e = l(e, l.EMPTY_OBJECT);
      var n = e.positions;
      this.width = l(e.width, 1), this._positions = n, this.granularity = l(e.granularity, 9999), this.loop = l(e.loop, !1), this.arcType = l(e.arcType, t.GEODESIC), this._ellipsoid = d.WGS84, this._projectionIndex = 0, this._workerName = "createGroundPolylineGeometry", this._scene3DOnly = !1;
    }
    ...
    function w(e, n, r, a, o, u, s, c, l, f, h) {
      if (0 !== o) {
        ...
        if (!(m < o)) for (var _ = I(e, n, a, s, J), y = Math.ceil(m / o), T = m / y, R = T, A = y - 1, v = c.length, g = 0; g < A; g++) {
          var S = d.interpolateUsingSurfaceDistance(R, j),
              O = N(s, S, r, Z),
              M = N(s, S, a, K);
          i.pack(_, c, v), i.pack(O, l, v), i.pack(M, f, v), h.push(S.latitude), h.push(S.longitude), v += 3, R += T;
        }
      }
    }
    ...
    function P(e, t, n, r, a) {
      ...
      return i.normalize(d, d), i.cross(d, o, a), i.normalize(a, a), i.dot(s, d) < ae && (a = i.negate(a, a)), a;
    }
    ...
    function U(e, t, n, r, o) {
      ...
      Math.abs(t.longitude - h.longitude) > c.PI_OVER_TWO && (l = !0, s = i.subtract(u, n, Ae), h = f.cartesianToCartographic(s, Te)), h.height = 0;
      var d = e.project(h, o);
      return o = i.subtract(d, r, o), o.z = 0, o = i.normalize(o, o), l && i.negate(o, o), o;
    }
    ...
    function L(e, t) {
      var n = v.getPointDistance(oe, e),
          ...
          a = Se;
      c.equalsEpsilon(n, 0, c.EPSILON2) ? (a = C(t, e, a), i.multiplyByScalar(a, c.EPSILON2, a), i.add(e, a, e)) : c.equalsEpsilon(r, 0, c.EPSILON2) && (a = C(e, t, a), i.multiplyByScalar(a, c.EPSILON2, a), i.add(t, a, t));
    }
    ...
    function b(t, n, a, o, s, l, f) {
      ...
      f && (p = new Float32Array(O), E = new Float32Array(O), _ = new Float32Array(O), R = new Float32Array(2 * g));
      var V = l.length / 2,
          W = 0,
          X = Oe;
      X.height = 0;
      ...
      var k = Ie,
          Y = we;
      if (f) for (d = 0, h = 1; h < V; h++) {
        X.latitude = l[d], X.longitude = l[d + 1], H.latitude = l[d + 2], H.longitude = l[d + 3], k = n.project(X, k), Y = n.project(H, Y), W += i.distance(k, Y), d += 2;
      }
      var j = o.length / 3;
      Y = i.unpack(o, 0, Y);
      var Z = 0;
      ...
      for (h = 0; h < v; h++) {
        var se = i.clone(ne, Ne),
            ce = i.clone(re, Ie),
            le = i.clone(ie, Pe);
        te && (le = i.negate(le, le)), ne = i.unpack(a, d, Ce), re = i.unpack(o, d, we), ie = i.unpack(s, d, xe), te = x(ie, se, ne, re), X.latitude = l[J], X.longitude = l[J + 1], H.latitude = l[J + 2], H.longitude = l[J + 3];
        var fe, he, de, pe;
        ...
        if (f) {
          ...
          var me = C(he, fe, Je);
          me.y = Math.abs(me.y), de = Ge, pe = Ve, 0 === Ee || i.dot(me, i.UNIT_Y) > G ? (de = U(n, X, le, fe, Ge), pe = U(n, H, ie, he, Ve)) : 1 === Ee ? (pe = U(n, H, ie, he, Ve), de.x = 0, de.y = c.sign(X.longitude - Math.abs(H.longitude)), de.z = 0) : (de = U(n, X, le, fe, Ge), pe.x = 0, pe.y = c.sign(X.longitude - H.longitude), pe.z = 0);
        }
        ...
        if (f) {
          ct = i.distance(fe, he), it = m.fromCartesian(fe, Ke), at = i.subtract(he, fe, Je), ot = i.normalize(at, Qe);
          var ht = ot.x;
        ...
        for (K = 0; K < 8; K++) {
          ...
          i.pack(ye.high, N, dt), N[Et] = Te.x, i.pack(ye.low, P, dt), P[Et] = Te.y, i.pack(ge, b, dt), b[Et] = Te.z, i.pack(rt, q, dt), q[Et] = ut * mt, i.pack(ve, z, dt);
          var yt = st * _t;
          0 === yt && _t < 0 && (yt = Number.POSITIVE_INFINITY), z[Et] = yt, f && (p[dt] = it.high.x, p[dt + 1] = it.high.y, p[dt + 2] = it.low.x, p[dt + 3] = it.low.y, _[dt] = -de.y, _[dt + 1] = de.x, _[dt + 2] = pe.y, _[dt + 3] = -pe.x, E[dt] = at.x, E[dt + 1] = at.y, E[dt + 2] = ot.x, E[dt + 3] = ot.y, R[pt] = lt * mt, yt = ft * _t, 0 === yt && _t < 0 && (yt = Number.POSITIVE_INFINITY), R[pt + 1] = yt);
        }
        ...
        i.add(Tt, It, Tt), i.add(Rt, It, Rt), i.add(At, It, At), i.add(vt, It, vt), L(Tt, Rt), L(At, vt), i.pack(Tt, w, $), i.pack(Rt, w, $ + 3), i.pack(vt, w, $ + 6), i.pack(At, w, $ + 9), It = i.multiplyByScalar(ve, -2 * c.EPSILON5, $e), i.add(Tt, It, Tt), i.add(Rt, It, Rt), i.add(At, It, At), i.add(vt, It, vt), L(Tt, Rt), L(At, vt), i.pack(Tt, w, $ + 12), i.pack(Rt, w, $ + 15), i.pack(vt, w, $ + 18), i.pack(At, w, $ + 21), J += 2, d += 3, Q += 16, $ += 24, ee += 32, ae += _e, oe += ct;
      }
      ...
      return f && (Pt.startHiLo2D = B(p), Pt.offsetAndRight2D = B(E), Pt.startEndNormals2D = B(_), Pt.texcoordNormalization2D = new T({
    ...
    M.pack = function (e, t, n) {
      ...
      return t[r++] = e.granularity, t[r++] = e.loop ? 1 : 0, t[r++] = e.arcType, d.pack(e._ellipsoid, t, r), r += d.packedLength, t[r++] = e._projectionIndex, t[r++] = e._scene3DOnly ? 1 : 0, t;
      ...
      return f(n) || (n = new M({
        positions: o
      })), n._positions = o, n.granularity = s, n.loop = c, n.arcType = h, n._ellipsoid = p, n._projectionIndex = E, n._scene3DOnly = m, n;
    };
    var $ = new i(),
        ee = new i(),
        te = new i(),
    ...
    M.createGeometry = function (e) {
      ...
      for (o = 0; o < T - 1; o++) {
        A = y[o], v = y[o + 1], O = R.lineSegmentPlane(A, v, oe, he), !f(O) || i.equalsEpsilon(O, A, c.EPSILON7) || i.equalsEpsilon(O, v, c.EPSILON7) || (e.arcType === t.GEODESIC ? U.push(i.clone(O)) : e.arcType === t.RHUMB && (C = l.cartesianToCartographic(O, de).longitude, g = l.cartesianToCartographic(A, de), S = l.cartesianToCartographic(v, pe), x.setEndPoints(g, S), M = x.findIntersectionWithLongitude(C, Ee), O = l.cartographicToCartesian(M, he), !f(O) || i.equalsEpsilon(O, A, c.EPSILON7) || i.equalsEpsilon(O, v, c.EPSILON7) || U.push(i.clone(O)))), U.push(v);
      }

      s && (A = y[T - 1], v = y[0], O = R.lineSegmentPlane(A, v, oe, he), !f(O) || i.equalsEpsilon(O, A, c.EPSILON7) || i.equalsEpsilon(O, v, c.EPSILON7) || (e.arcType === t.GEODESIC ? U.push(i.clone(O)) : e.arcType === t.RHUMB && (C = l.cartesianToCartographic(O, de).longitude, g = l.cartesianToCartographic(A, de), S = l.cartesianToCartographic(v, pe), x.setEndPoints(g, S), M = x.findIntersectionWithLongitude(C, Ee), O = l.cartographicToCartesian(M, he), !f(O) || i.equalsEpsilon(O, A, c.EPSILON7) || i.equalsEpsilon(O, v, c.EPSILON7) || U.push(i.clone(O)))));
      var D = U.length,
          L = new Array(D);
      ...
      if (L = n(L, a.equalsEpsilon), !((D = L.length) < 2)) {
        ...
        for (H = N(l, Q, m, H), j = N(l, J, m, j), k = N(l, K, m, k), Y = N(l, K, _, Y), Z = s ? P(H, k, Y, j, Z) : I(K, J, _, l, Z), i.pack(Z, z, 0), i.pack(k, G, 0), i.pack(Y, V, 0), B.push(K.latitude), B.push(K.longitude), w(K, J, m, _, h, d, l, z, G, V, B), o = 1; o < D - 1; ++o) {
          H = i.clone(k, H), k = i.clone(j, k);
          var $ = L[o];
          N(l, $, _, Y), N(l, L[o + 1], m, j), P(H, k, Y, j, Z), r = z.length, i.pack(Z, z, r), i.pack(k, G, r), i.pack(Y, V, r), B.push($.latitude), B.push($.longitude), w(L[o], L[o + 1], m, _, h, d, l, z, G, V, B);
        }
        ...
        if (r = z.length, i.pack(Z, z, r), i.pack(k, G, r), i.pack(Y, V, r), B.push(ee.latitude), B.push(ee.longitude), s) {
    ...
    var me = new i(),
        ...
        $e = new i(),
        et = [new r(), new r()],
        tt = [0, 2, 1, 0, 3, 2, 0, 7, 3, 0, 4, 7, 0, 5, 4, 0, 1, 5, 5, 7, 4, 5, 6, 7, 5, 2, 6, 5, 1, 2, 3, 6, 2, 3, 7, 6],
        nt = tt.length;

    return M._projectNormal = U, M;
  }), define("Workers/createGroundPolylineGeometry", ["../Core/ApproximateTerrainHeights", "../Core/defined", "../Core/GroundPolylineGeometry"], function (e, t, n) {
    "use strict";
