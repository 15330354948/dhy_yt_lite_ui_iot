...
!function () {
  define("Core/defined", [], function () {
    ...
    function i(n, i, u, s, c) {
      ...
      do {
        F -= B, N = 1 / (1 + F * R), x = 1 / (1 + F * A), M = 1 / (1 + F * S), C = N * N, P = x * x, b = M * M, D = C * N, U = P * x, L = b * M, O = y * C + E * P + _ * b - 1, I = y * D * R + E * U * A + _ * L * S;
        B = O / (-2 * I);
    ...
    s.packedLength = 9, s.pack = function (e, t, r) {
      ...
      return r(t) ? (t[0] = p, t[1] = E, t[2] = T, t[3] = m, t[4] = _, t[5] = g, t[6] = y, t[7] = v, t[8] = R, t) : new s(p, m, y, E, _, v, T, g, R);
      ...
      return r(t) ? (t[0] = l, t[1] = d, t[2] = y, t[3] = f, t[4] = p, t[5] = E, t[6] = h, t[7] = m, t[8] = _, t) : new s(l, f, h, d, p, m, y, E, _);
    ...
    l.packedLength = 16, l.pack = function (e, t, n) {
      ...
      return r[0] = v * a, r[1] = R * a, r[2] = w * a, r[3] = 0, r[4] = T * o, r[5] = A * o, r[6] = O * o, r[7] = 0, r[8] = g * u, r[9] = S * u, r[10] = I * u, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, r;
    ...
    l.fromCamera = function (t, n) {
      ...
      var u = h.x,
          ...
          S = E * -T + _ * -g + v * -R,
          w = p * T + m * g + y * R;
      return i(n) ? (n[0] = u, n[1] = E, n[2] = -p, n[3] = 0, n[4] = s, n[5] = _, n[6] = -m, n[7] = 0, n[8] = c, n[9] = v, n[10] = -y, n[11] = 0, n[12] = A, n[13] = S, n[14] = w, n[15] = 1, n) : new l(u, s, c, A, E, _, v, S, -p, -m, -y, w, 0, 0, 0, 1);
    ...
    l.getMaximumScale = function (t) {
      ...
      var r = e[0],
          ...
          Z = a * C + c * P + d * b + E * D,
          K = o * C + l * P + p * b + _ * D;
      return n[0] = U, n[1] = L, n[2] = F, n[3] = B, n[4] = z, n[5] = q, n[6] = G, n[7] = V, n[8] = W, n[9] = X, n[10] = H, n[11] = k, n[12] = Y, n[13] = j, n[14] = Z, n[15] = K, n;
      ...
      var r = e[0],
          ...
          F = i * S + u * w + l * O + d,
          B = a * S + s * w + f * O + p;
      return n[0] = I, n[1] = N, n[2] = x, n[3] = 0, n[4] = M, n[5] = C, n[6] = P, n[7] = 0, n[8] = b, n[9] = D, n[10] = U, n[11] = 0, n[12] = L, n[13] = F, n[14] = B, n[15] = 1, n;
      ...
      var r = e[0],
          ...
          N = i * _ + u * v + l * T,
          x = a * _ + s * v + f * T;
      return n[0] = g, n[1] = R, n[2] = A, n[3] = 0, n[4] = S, n[5] = w, n[6] = O, n[7] = 0, n[8] = I, n[9] = N, n[10] = x, n[11] = 0, n[12] = e[12], n[13] = e[13], n[14] = e[14], n[15] = e[15], n;
    ...
    return l.inverse = function (e, n) {
      ...
      I = a * p, N = o * d, x = i * p, M = o * h, C = i * d, P = a * h, b = r * p, D = o * f, U = r * d, L = a * f, F = r * h, B = i * f;
      ...
      if (Math.abs(te) < u.EPSILON21) {
        if (s.equalsEpsilon(l.getRotation(e, _), v, u.EPSILON7) && t.equals(l.getRow(e, 3, T), g)) return n[0] = 0, n[1] = 0, n[2] = 0, n[3] = 0, n[4] = 0, n[5] = 0, n[6] = 0, n[7] = 0, n[8] = 0, n[9] = 0, n[10] = 0, n[11] = 0, n[12] = -e[12], n[13] = -e[13], n[14] = -e[14], n[15] = 1, n;
        throw new c("matrix is not invertible because its determinate is zero.");
      }

      return te = 1 / te, n[0] = z * te, n[1] = q * te, n[2] = G * te, n[3] = V * te, n[4] = W * te, n[5] = X * te, n[6] = H * te, n[7] = k * te, n[8] = Y * te, n[9] = j * te, n[10] = Z * te, n[11] = K * te, n[12] = J * te, n[13] = Q * te, n[14] = $ * te, n[15] = ee * te, n;
    ...
    d.fromPoints = function (t, n) {
      ...
      for (r = 1; r < h; r++) {
        ...
        var O = a.x,
            I = a.y,
            N = a.z;
        O < o.x && e.clone(a, o), O > c.x && e.clone(a, c), I < u.y && e.clone(a, u), I > l.y && e.clone(a, l), N < s.z && e.clone(a, s), N > f.z && e.clone(a, f);
      }
      ...
      for (r = 0; r < h; r++) {
        ...
        if (W > L) {
          ...
          F = .5 * (F + X), L = F * F;
          var H = X - F;
          U.x = (F * U.x + H * a.x) / X, U.y = (F * U.y + H * a.y) / X, U.z = (F * U.z + H * a.z) / X;
        }
      }
    ...
    d.fromRectangle3D = function (t, n, o, u) {
      ...
      for (s = 0; s < N; s += a) {
        var x = t[s] + n.x,
            M = t[s + 1] + n.y,
            C = t[s + 2] + n.z;
        u.x = x, u.y = M, u.z = C, x < c.x && e.clone(u, c), x > h.x && e.clone(u, h), M < l.y && e.clone(u, l), M > O.y && e.clone(u, O), C < f.z && e.clone(u, f), C > I.z && e.clone(u, I);
      }
    ...
    e("ThirdParty/when", [], function () {
      ...
      function s(t, n, r, i, a) {
        return y(2, arguments), e(t, function (t) {
          ...
          if (_ = t.length >>> 0, c = Math.max(0, Math.min(n, _)), f = [], l = _ - c + 1, h = [], d = o(), c) for (y = d.progress, _m = function m(e) {
    ...
    s.fromRotationMatrix = function (e, t) {
      ...
      if (m > 0) n = Math.sqrt(m + 1), c = .5 * n, n = .5 / n, i = (e[u.COLUMN1ROW2] - e[u.COLUMN2ROW1]) * n, a = (e[u.COLUMN2ROW0] - e[u.COLUMN0ROW2]) * n, o = (e[u.COLUMN0ROW1] - e[u.COLUMN1ROW0]) * n;else {
        ...
        var _ = y[E],
            v = y[_];
        n = Math.sqrt(e[u.getElementIndex(E, E)] - e[u.getElementIndex(_, _)] - e[u.getElementIndex(v, v)] + 1);
        var T = f;
        T[E] = .5 * n, n = .5 / n, c = (e[u.getElementIndex(v, _)] - e[u.getElementIndex(_, v)]) * n, T[_] = (e[u.getElementIndex(_, E)] + e[u.getElementIndex(E, _)]) * n, T[v] = (e[u.getElementIndex(v, E)] + e[u.getElementIndex(E, v)]) * n, i = -T[0], a = -T[1], o = -T[2];
      }
    ...
    s.packedLength = 4, s.pack = function (e, t, r) {
      ...
      var u = e.magnitude(E);
      return s.unpack(n, 4 * a, v), 0 === u ? s.clone(s.IDENTITY, _) : s.fromAxisAngle(E, u, _), s.multiply(_, v, o);
    }, s.clone = function (e, t) {
    ...
    m.fromGregorianDate = function (e, t) {
      ...
      var n,
          ...
          N = u[0],
          x = u[1];
      if (null !== (u = N.match(A))) n = +u[1], s = +u[2], l = +u[3];else if (null !== (u = N.match(T))) n = +u[1], s = +u[2];else if (null !== (u = N.match(v))) n = +u[1];else {
        var M;
        if (null !== (u = N.match(g))) n = +u[1], M = +u[2], a = o(n);else if (null !== (u = N.match(R))) {
          n = +u[1];
          var C = +u[2],
              P = +u[3] || 0,
      ...
      if (r(x)) {
        u = x.match(I), null !== u ? (h = +u[1], y = +u[2], _ = +u[3], S = 1e3 * +(u[4] || 0), D = 5) : (u = x.match(O), null !== u ? (h = +u[1], y = +u[2], _ = 60 * +(u[3] || 0), D = 4) : null !== (u = x.match(w)) && (h = +u[1], y = 60 * +(u[2] || 0), D = 3));
        var U = u[D],
            L = +u[D + 1],
            F = +(u[D + 2] || 0);
    ...
    return m.toGregorianDate = function (e, t) {
      ...
      return _ += 12, _ > 23 && (_ -= 24), n && (g += 1), r(t) ? (t.year = E, t.month = y, t.day = p, t.hour = _, t.minute = T, t.second = g, t.millisecond = R, t.isLeapSecond = n, t) : new a(E, y, p, _, T, g, R, n);
    }, m.toDate = function (e) {
    ...
    return h.maximumRequests = 50, h.maximumRequestsPerServer = 6, h.requestsByServer = {
      ...
      for (e = 0; e < r; ++e) {
        t = S[e], t.cancelled && v(t), t.state === l.ACTIVE ? n > 0 && (S[e - n] = t) : ++n;
      }
    ...
    C.supportsImageBitmapOptions = function () {
      ...
      var n = o(e.preferImageBitmap, !1),
          r = o(e.preferBlob, !1),
          i = o(e.flipY, !1);
      if (x(this.request), !q || this.isDataUri || this.isBlobUri || !this.hasHeaders && !r) return P({
        resource: this,
        flipY: i,
        preferImageBitmap: n
      });
    ...
    C.prototype.fetch = function (e) {
      ...
      return r.defined("data", e), t = N(t, {}), t.method = "POST", t.data = e, this._makeRequest(t);
    }, C.post = function (e) {
      ...
      return r.defined("data", e), t = N(t, {}), t.method = "PUT", t.data = e, this._makeRequest(t);
    }, C.put = function (e) {
      ...
      return r.defined("data", e), t = N(t, {}), t.method = "PATCH", t.data = e, this._makeRequest(t);
    }, C.patch = function (e) {
        ...
        if (!(o >= this._totalSamples)) {
          ...
          if (r(d[3 * s]) || (l(this, s / this._samplesPerXysFile | 0), h = !0), r(d[3 * f]) || (l(this, f / this._samplesPerXysFile | 0), h = !0), !h) {
            ...
            for (p = 0; p <= u; ++p) {
              ...
              v[p] *= _[p];
              var g = 3 * (s + p);
              n.x += v[p] * d[g++], n.y += v[p] * d[g++], n.s += v[p] * d[g];
            }
    ...
    g.localFrameToFixedFrameGenerator = function (e, t) {
      ...
      return u(S[a]) ? r = S[a] : (r = function r(_r, a, s) {
        if (u(s) || (s = new _()), y.equalsEpsilon(_r.x, 0, y.EPSILON14) && y.equalsEpsilon(_r.y, 0, y.EPSILON14)) {
          var c = y.sign(_r.z);
          n.unpack(A[e], 0, O), "east" !== e && "west" !== e && n.multiplyByScalar(O, c, O), n.unpack(A[t], 0, I), "east" !== t && "west" !== t && n.multiplyByScalar(I, c, I), n.unpack(A[i], 0, N), "east" !== i && "west" !== i && n.multiplyByScalar(N, c, N);
        } else {
          a = o(a, f.WGS84), a.geodeticSurfaceNormal(_r, w.up);
          var l = w.up,
              h = w.east;
          h.x = -_r.y, h.y = _r.x, h.z = 0, n.normalize(h, w.east), n.cross(l, h, w.north), n.multiplyByScalar(w.up, -1, w.down), n.multiplyByScalar(w.east, -1, w.west), n.multiplyByScalar(w.north, -1, w.south), O = w[e], I = w[t], N = w[i];
        }

        return s[0] = O.x, s[1] = O.y, s[2] = O.z, s[3] = 0, s[4] = I.x, s[5] = I.y, s[6] = I.z, s[7] = 0, s[8] = N.x, s[9] = N.y, s[10] = N.z, s[11] = 0, s[12] = _r.x, s[13] = _r.y, s[14] = _r.z, s[15] = 1, s;
      }, S[a] = r), r;
      ...
      if (u(n)) {
        ...
        if (u(a)) {
          ...
          var M = -47e-6 * x * y.RADIANS_PER_DEGREE / 3600,
              ...
              P = Math.sin(M),
              b = H;
          return b[0] = w * C, b[1] = w * P, b[2] = I, b[3] = -O * P + N * I * C, b[4] = O * C + N * I * P, b[5] = -N * w, b[6] = -N * P - O * I * C, b[7] = N * C - O * I * P, b[8] = O * w, E.multiply(S, b, t);
        }
      }
    };
    ...
    return y._textureCoordinateRotationPoints = function (r, i, a, o) {
      ...
      for (u = 0; u < 3; u++) {
        n.toCartesian(x[u], a, M), M = f.multiplyByPointAsVector(I, M, M), N[u].x = M.x, N[u].y = M.y;
      }
    ...
    function a(n, a, c, l, f) {
      ...
      if (r(a.z)) {
        ...
        h = t.subtract(c, a, o), d = t.subtract(l, a, u), p = t.subtract(n, a, s), m = t.dot(h, h), y = t.dot(h, d), E = t.dot(h, p), _ = t.dot(d, d), v = t.dot(d, p);
      } else {
        ...
        h = e.subtract(c, a, o), d = e.subtract(l, a, u), p = e.subtract(n, a, s), m = e.dot(h, h), y = e.dot(h, d), E = e.dot(h, p), _ = e.dot(d, d), v = e.dot(d, p);
      }
    ...
    function n(e, t, n, r) {
      ...
      if (E < 0) {
        ...
        var A = a / 2,
            ...
            w = a === R ? -S : -v / S;
        return i = v <= 0 ? S + w : -T / (S * S + w * w + v), h * f >= l * d ? [(i - u) / o] : [-c / (i + s)];
      }
    ...
    function a(t, i, a, o) {
      ...
      if (d.length > 0) {
        ...
        var I, N;
        0 === v && 0 === p ? (I = 0, N = 0) : n.sign(v) === n.sign(p) ? (I = v + p, N = y / I) : (N = v - p, I = y / N);
        var x, M;
        0 === T && 0 === m ? (x = 0, M = 0) : n.sign(T) === n.sign(m) ? (x = T + m, M = o / x) : (M = T - m, x = o / M);
    ...
    m.grazingAltitudeLocation = function (t, n) {
      ...
      if (V > 0) {
        ...
        return X = o.clamp(X, 0, 1), R = e.magnitude(e.subtract(W, i, x)) * Math.sqrt(1 - X * X), R = c ? -R : R, j.height = R, n.cartographicToCartesian(j, new e());
      }
    };
      ...
      for (var O, I; -1 !== y;) {
        ...
        for (var N = 0; N < I; ++N) {
          if (m = v.vertexTriangles[N], !w[m]) {
            ...
            for (var x = 0; x < 3; ++x) {
              O = a[l], T.push(O), g.push(O), A[R] = O, ++R, _ = p[O], --_.numLiveTriangles, E - _.timeStamp > u && (_.timeStamp = E, ++E), ++l;
            }
          }
        }
    ...
    function H(e, t, n) {
      if (!(e.x >= 0 || t.x >= 0 || n.x >= 0)) {
        ...
        var u = xe.indices;
        1 === o ? (u[1] = 3, u[2] = 4, u[5] = 6, u[7] = 6, u[8] = 5, r ? (X(e, t, we, Ie), X(e, n, Oe, Ne), u[0] = 0, u[3] = 1, u[4] = 2, u[6] = 1) : i ? (X(t, n, we, Ie), X(t, e, Oe, Ne), u[0] = 1, u[3] = 2, u[4] = 0, u[6] = 2) : a && (X(n, e, we, Ie), X(n, t, Oe, Ne), u[0] = 2, u[3] = 0, u[4] = 1, u[6] = 0)) : 2 === o && (u[2] = 4, u[4] = 4, u[5] = 3, u[7] = 5, u[8] = 6, r ? i ? a || (X(n, e, we, Ie), X(n, t, Oe, Ne), u[0] = 0, u[1] = 1, u[3] = 0, u[6] = 2) : (X(t, n, we, Ie), X(t, e, Oe, Ne), u[0] = 2, u[1] = 0, u[3] = 2, u[6] = 1) : (X(e, t, we, Ie), X(e, n, Oe, Ne), u[0] = 1, u[1] = 2, u[3] = 1, u[6] = 0));
        var s = xe.positions;
        return s[0] = e, s[1] = t, s[2] = n, s.length = 3, 1 !== o && 2 !== o || (s[3] = we, s[4] = Oe, s[5] = Ie, s[6] = Ne, s.length = 7), xe;
      }
    }
    ...
    function j(e, t, n) {
      ...
      t = k(t, r), n = k(n, r), c(n) && !c(t) ? e.geometry = n : !c(n) && c(t) ? e.geometry = t : (e.westHemisphereGeometry = t, e.eastHemisphereGeometry = n, e.geometry = void 0);
    }
    ...
    function K(e, n, r, a, o, u, s, l, f, h, d, p, m, y, E, _) {
      if (c(u) || c(s) || c(l) || c(f) || c(h) || 0 !== y) {
        ...
        if (c(u) && Ce(e, n, r, R, u, p.normal.values, _, !0), c(h)) {
          ...
          var O;
          i.equals(A, i.ZERO) && i.equals(S, i.ZERO) && i.equals(w, i.ZERO) ? (O = De, O.x = 0, O.y = 0, O.z = 0) : (O = i.add(A, S, A), i.add(O, w, O), i.normalize(O, O)), i.pack(O, p.extrudeDirection.values, 3 * _);
        }

        if (c(d) && be(e, n, r, R, d, p.applyOffset.values, _), c(s) && Ce(e, n, r, R, s, p.tangent.values, _, !0), c(l) && Ce(e, n, r, R, l, p.bitangent.values, _, !0), c(f) && Pe(e, n, r, R, f, p.st.values, _), y > 0) for (var I = 0; I < y; I++) {
          var N = m[I];
          J(e, n, r, R, _, E[N], p[N]);
        }
      }
    ...
    function $(e) {
      ...
      for (S.length = r.length / 3, v = 0; v < A.length; ++v) {
        A[v] = -1, S[v] = -1;
      }
      ...
      for (v = 0; v < w; v += 3) {
        ...
        if (c(P) && P.positions.length > 3) for (var b = P.positions, D = P.indices, U = D.length, L = 0; L < U; ++L) {
          var F = D[L],
              B = b[F];
          B.y < 0 ? (m = R.attributes, y = R.indices, E = A) : (m = g.attributes, y = g.indices, E = S), _ = Q(m, y, E, h, F < 3 ? v + F : -1, B), K(O, I, N, B, r, a, u, o, s, l, f, m, d, T, n, _);
        } else c(P) && (x = P.positions[0], M = P.positions[1], C = P.positions[2]), x.y < 0 ? (m = R.attributes, y = R.indices, E = A) : (m = g.attributes, y = g.indices, E = S), _ = Q(m, y, E, h, v, x), K(O, I, N, x, r, a, u, o, s, l, f, m, d, T, n, _), _ = Q(m, y, E, h, v + 1, M), K(O, I, N, M, r, a, u, o, s, l, f, m, d, T, n, _), _ = Q(m, y, E, h, v + 2, C), K(O, I, N, C, r, a, u, o, s, l, f, m, d, T, n, _);
      }
    ...
    function ee(e, t, n, r, a, o, u) {
      if (c(u)) {
        ...
        i.equalsEpsilon(s, n, v.EPSILON10) ? o.applyOffset.values[a] = u[e] : o.applyOffset.values[a] = u[t];
      }
    }
    ...
    function te(e) {
      ...
      for (t = 0; t < f; t += 2) {
        ...
        if (c(I)) {
          ...
          var x = i.add(I, N, Ge);
          p = Q(g, R, A, u, t, E), ee(m, y, E, a, p, g, o), p = Q(g, R, A, u, -1, x), ee(m, y, x, a, p, g, o), i.negate(N, N), i.add(I, N, x), p = Q(S, w, O, u, -1, x), ee(m, y, x, a, p, S, o), p = Q(S, w, O, u, t + 1, T), ee(m, y, T, a, p, S, o);
        } else {
          var M, C, P;
    ...
    function re(e) {
      ...
      for (t = 0; t < g; t += 4) {
        ...
        if (c(M)) {
          ...
          S.y < 0 && (i.negate(C, C), O = E.attributes, I = E.indices, N = y.attributes, x = y.indices);
          var P = i.add(M, C, Ze);
          ...
          var b = r.fromArray(d, 2 * R, Ve),
              D = Math.abs(b.y);
          O.expandAndWidth.values.push(-1, D, 1, D), O.expandAndWidth.values.push(-1, -D, 1, -D), N.expandAndWidth.values.push(-1, D, 1, D), N.expandAndWidth.values.push(-1, -D, 1, -D);
          ...
          if (U /= i.magnitudeSquared(i.subtract(w, S, ke)), c(m)) {
            ...
            for (O.color.values.push(B, z, q, G), O.color.values.push(B, z, q, G), N.color.values.push(B, z, q, G), N.color.values.push(B, z, q, G), n = 4 * A; n < 4 * A + 8; ++n) {
          ...
          if (c(p)) {
            ...
            for (O.st.values.push(X, V.y), O.st.values.push(X, W.y), N.st.values.push(X, V.y), N.st.values.push(X, W.y), n = 2 * A; n < 2 * A + 4; ++n) {
              N.st.values.push(p[n]);
            }
          }

          o = O.position.values.length / 3 - 4, I.push(o, o + 2, o + 1), I.push(o + 1, o + 2, o + 3), o = N.position.values.length / 3 - 4, x.push(o, o + 2, o + 1), x.push(o + 1, o + 2, o + 3);
        } else {
          var H, k;

          for (S.y < 0 ? (H = E.attributes, k = E.indices) : (H = y.attributes, k = y.indices), H.position.values.push(S.x, S.y, S.z), H.position.values.push(S.x, S.y, S.z), H.position.values.push(w.x, w.y, w.z), H.position.values.push(w.x, w.y, w.z), n = 3 * t; n < 3 * t + 12; ++n) {
    ...
    ie.toWireframe = function (e) {
      ...
      if (c(e.indices) && n >= v.SIXTY_FOUR_KILOBYTES) {
        ...
        for (var f = 0; f < l; f += r) {
          ...
          o + r >= v.SIXTY_FOUR_KILOBYTES && (t.push(new d({
            attributes: u,
            indices: a,
            primitiveType: e.primitiveType,
    ...
    ie.computeNormal = function (e) {
      ...
      for (t = 0; t < o; t++) {
        ...
        i.equalsEpsilon(i.ZERO, he, v.EPSILON10) && (he.z = 1), i.normalize(he, he), S[w] = he.x, S[w + 1] = he.y, S[w + 2] = he.z;
      }
    ...
    ie.compressVertices = function (t) {
      ...
      for (n = 0; n < a; ++n) {
        ...
        var x = 3 * n;
        m && c(v) && c(T) ? (i.fromArray(E, x, Te), i.fromArray(v, x, ge), i.fromArray(T, x, Re), e.octPack(Te, ge, Re, ve), I[N++] = ve.x, I[N++] = ve.y) : (m && (i.fromArray(E, x, Te), I[N++] = e.octEncodeFloat(Te)), A && (i.fromArray(v, x, Te), I[N++] = e.octEncodeFloat(Te)), S && (i.fromArray(T, x, Te), I[N++] = e.octEncodeFloat(Te)));
      }
  ...
  }), define("Core/oneTimeWarning", ["./defaultValue", "./defined", "./DeveloperError"], function (e, t, n) {
    "use strict";
    ...
    function t(e, t, n, r, i) {
      var a, o;
      if (i === N(e, t, n, r) > 0) for (a = t; a < n; a += r) {
        o = w(a, e[a], e[a + 1], o);
    ...
    function n(e, t) {
      ...
      do {
        if (n = !1, r.steiner || !v(r, r.next) && 0 !== _(r.prev, r, r.next)) r = r.next;else {
    ...
    function i(e) {
      ...
      for (var i = e.next.next; i !== e.prev;) {
        if (y(t.x, t.y, n.x, n.y, r.x, r.y, i.x, i.y) && _(i.prev, i, i.next) >= 0) return !1;
        i = i.next;
      }
    ...
    function o(e, t, n) {
      ...
      do {
        var i = r.prev,
            a = r.next.next;
        !v(i, a) && T(i, r, r.next, a) && R(i, a) && R(a, i) && (t.push(i.i / n), t.push(r.i / n), t.push(a.i / n), O(r), O(r.next), r = e = a), r = r.next;
      } while (r !== e);
    ...
    function p(n, r, i, a) {
      var o = (e.normalize(a.cartographicToCartesian(r, _), E), e.normalize(a.cartographicToCartesian(i, _), _), a.maximumRadius),
          u = a.minimumRadius,
          s = o * o,
          c = u * u;
    ...
    E.computeSubdivision = function (e, t, r, i) {
      ...
      for (var w = [], O = {}, I = e.maximumRadius, N = h.chordLength(i, I), x = N * N; c.length > 0;) {
        var M,
            C,
            P = c.pop(),
            b = c.pop(),
            ...
            X = Math.max(G, V, W);
        X > x ? G === X ? (M = Math.min(D, b) + " " + Math.max(D, b), s = O[M], u(s) || (C = n.add(U, L, S), n.multiplyByScalar(C, .5, C), m.push(C.x, C.y, C.z), s = m.length / 3 - 1, O[M] = s), c.push(D, s, P), c.push(s, b, P)) : V === X ? (M = Math.min(b, P) + " " + Math.max(b, P), s = O[M], u(s) || (C = n.add(L, F, S), n.multiplyByScalar(C, .5, C), m.push(C.x, C.y, C.z), s = m.length / 3 - 1, O[M] = s), c.push(b, s, D), c.push(s, P, D)) : W === X && (M = Math.min(P, D) + " " + Math.max(P, D), s = O[M], u(s) || (C = n.add(F, U, S), n.multiplyByScalar(C, .5, C), m.push(C.x, C.y, C.z), s = m.length / 3 - 1, O[M] = s), c.push(P, s, b), c.push(s, D, b)) : (w.push(D), w.push(b), w.push(P));
      }
    ...
    m.prototype.projectPointOntoPlane = function (e, r) {
      ...
      if (o(a) || (n.negate(i.direction, i.direction), a = l.rayPlane(i, this._plane, v)), o(a)) {
      ...
      var a = l.rayPlane(i, this._plane, v);
      o(a) || (n.negate(i.direction, i.direction), a = l.rayPlane(i, this._plane, v));
      var u = n.subtract(a, this._origin, a),
          s = n.dot(this._xAxis, u),
          c = n.dot(this._yAxis, u);
    ...
    function s(e) {
      ...
      S.a = n, S.b = r, S.f = i, S.cosineHeading = a, S.sineHeading = o, S.tanU = u, S.cosineU = s, S.sineU = c, S.sigma = l, S.sineAlpha = f, S.sineSquaredAlpha = h, S.cosineSquaredAlpha = d, S.cosineAlpha = p, S.u2Over4 = m, S.u4Over16 = y, S.u6Over64 = E, S.u8Over256 = _, S.a0 = v, S.a1 = T, S.a2 = g, S.a3 = R, S.distanceRatio = A;
    }
    ...
    function f(e, t, n, r, i, a, o) {
      ...
      do {
        ...
        var C;
        0 === f ? (C = 0, h = 1) : (C = R * x / f, h = 1 - C * C), I = O, d = c - 2 * S / h, isNaN(d) && (d = 0), O = m + l(p, C, h, s, f, c, d);
    ...
    return a(d.prototype, {
      ...
      return i(n) ? (n.longitude = this._start.longitude + x, n.latitude = R, n.height = 0, n) : new t(this._start.longitude + x, R, 0);
    }, d;
    ...
    function p(t, n, r, i, a, o, u, s) {
      ...
      for (var T = 1; T < f; T++) {
        ...
        g.height = m[T], v = i.cartographicToCartesian(g, x), e.pack(v, u, _), _ += 3;
      }
    ...
    function m(t, n, r, i, a, o, s, c) {
      ...
      for (var g = 1; g < m; g++) {
        ...
        R.height = E[g], T = i.cartographicToCartesian(R, x), e.pack(T, s, v), v += 3;
      }
    ...
    y.wrapLongitude = function (t, i) {
        ...
        for (var E = a[0], O = t.length, I = 1; I < O; ++I) {
          ...
          if (h.getPointDistance(m, E) < 0 || h.getPointDistance(m, N) < 0) {
            ...
            if (r(x)) {
              ...
              h.getPointDistance(d, E) < 0 && e.negate(M, M), a.push(e.add(x, M, new e())), o.push(y + 1), e.negate(M, M), a.push(e.add(x, M, new e())), y = 1;
            }
          }
      ...
      for (_ = 0; _ < o - 1; _++) {
        v += y.numberOfPoints(i[_], i[_ + 1], m);
      }
    ...
    var D = new t(),
        U = new t();
    return y.generateRhumbArc = function (i) {
      r(i) || (i = {});
      var o = i.positions,
          u = o.length,
      ...
      for (E = 0; E < u - 1; E++) {
        _ = s.cartesianToCartographic(o[E + 1], U), T += y.numberOfPointsRhumbLine(g, _, v), g = t.clone(_, D);
      }
      ...
      for (var n = y.generateArc(t), r = n.length / 3, i = new Array(r), a = 0; a < r; a++) {
        i[a] = e.unpack(n, 3 * a);
      }

      return i;
    }, y.generateCartesianRhumbArc = function (t) {
      for (var n = y.generateRhumbArc(t), r = n.length / 3, i = new Array(r), a = 0; a < r; a++) {
        i[a] = e.unpack(n, 3 * a);
      }
    ...
    function h(e, t) {
      for (var n = new Array(e.length), r = 0; r < e.length; r++) {
        var i = e[r];
        b = t.cartesianToCartographic(i, b), n[r] = b.height, e[r] = t.scaleToGeodeticSurface(i, i);
      }
    ...
    function m(e, n, r, i, a, o, c, l) {
      ...
      for (var E = 0; E < l; E++) {
        for (var _ = 0; _ < r.length; _ += 3) {
          d = t.fromArray(r, _, d), d = u.multiplyByVector(y, d, d), d = s.multiplyByPoint(F, d, d), i.push(d.x, d.y, d.z);
        }
      }
    ...
    function v(e, n, r, a, s, c, f, h, d, p) {
      ...
      y = s ? u.fromQuaternion(l.fromAxisAngle(t.negate(e, M), E / (_ + 1), H), Y) : u.fromQuaternion(l.fromAxisAngle(e, E / (_ + 1), H), Y);
      var v, T;
      if (n = t.clone(n, k), _ > 0) for (var g = p ? 2 : 1, R = 0; R < _; R++) {
        n = u.multiplyByVector(y, n, n), v = t.subtract(n, e, M), v = t.normalize(v, v), s || (v = t.negate(v, v)), T = c.scaleToGeodeticSurface(n, C), f = m(T, v, h, f, c, d, 1, g);
      } else v = t.subtract(n, e, M), v = t.normalize(v, v), s || (v = t.negate(v, v)), T = c.scaleToGeodeticSurface(n, C), f = m(T, v, h, f, c, d, 1, 1), r = t.clone(r, k), v = t.subtract(r, e, M), v = t.normalize(v, v), s || (v = t.negate(v, v)), T = c.scaleToGeodeticSurface(r, C), f = m(T, v, h, f, c, d, 1, 1);
      return f;
    }
    ...
    return P.computePositions = function (e, n, r, a, u) {
      var s = a._ellipsoid,
          ...
          K = e[0],
          J = e[1];
      V = s.geodeticSurfaceNormal(K, V), z = t.subtract(J, K, z), z = t.normalize(z, z), k = t.cross(V, z, k), k = t.normalize(k, k);
      var Q = l[0],
          $ = l[1];
      u && (B = m(K, k, b, B, s, Q + D, 1, 1)), Y = t.clone(K, Y), K = J, q = t.negate(z, q);
      ...
      for (var ee, te, ne = 1; ne < L - 1; ne++) {
        ...
        if (!o.equalsEpsilon(Math.abs(t.dot(ie, ae)), 1, o.EPSILON7)) {
          ...
          var oe = 1 / Math.max(.25, t.magnitude(t.cross(G, q, M))),
              ue = P.angleIsGreaterThanPi(z, q, K, s);
          ue ? (W = t.add(K, t.multiplyByScalar(G, oe * U, G), W), X = t.add(W, t.multiplyByScalar(k, U, X), X), T[0] = t.clone(Y, T[0]), T[1] = t.clone(X, T[1]), ee = d(T, Q + D, $ + D, f), te = c.generateArc({
            positions: T,
            granularity: f,
            ellipsoid: s
          }), F = y(te, k, C, F, s, ee, 1), k = t.cross(V, z, k), k = t.normalize(k, k), H = t.add(W, t.multiplyByScalar(k, U, H), H), p === i.ROUNDED || p === i.BEVELED ? v(W, X, H, p, ue, s, F, C, $ + D, u) : (G = t.negate(G, G), F = m(K, G, C, F, s, $ + D, oe, re)), Y = t.clone(H, Y)) : (W = t.add(K, t.multiplyByScalar(G, oe * U, G), W), X = t.add(W, t.multiplyByScalar(k, -U, X), X), T[0] = t.clone(Y, T[0]), T[1] = t.clone(X, T[1]), ee = d(T, Q + D, $ + D, f), te = c.generateArc({
            positions: T,
            granularity: f,
            ellipsoid: s
          }), F = y(te, k, C, F, s, ee, 1), k = t.cross(V, z, k), k = t.normalize(k, k), H = t.add(W, t.multiplyByScalar(k, -U, H), H), p === i.ROUNDED || p === i.BEVELED ? v(W, X, H, p, ue, s, F, C, $ + D, u) : F = m(K, G, C, F, s, $ + D, oe, re), Y = t.clone(H, Y)), q = t.negate(z, q);
        } else F = m(Y, k, C, F, s, Q + D, 1, 1), Y = K;

        Q = $, $ = l[ne + 1], K = J;
      }

      T[0] = t.clone(Y, T[0]), T[1] = t.clone(K, T[1]), ee = d(T, Q + D, $ + D, f), te = c.generateArc({
        positions: T,
        granularity: f,
        ellipsoid: s
      }), F = y(te, k, C, F, s, ee, 1), u && (B = m(K, k, b, B, s, $ + D, 1, 1)), L = F.length;
  ...
  }), define("Core/PolylineVolumeGeometry", ["./arrayRemoveDuplicates", "./BoundingRectangle", "./BoundingSphere", "./Cartesian2", "./Cartesian3", "./ComponentDatatype", "./CornerType", "./defaultValue", "./defined", "./DeveloperError", "./Ellipsoid", "./Geometry", "./GeometryAttribute", "./GeometryAttributes", "./GeometryPipeline", "./IndexDatatype", "./Math", "./oneTimeWarning", "./PolygonPipeline", "./PolylineVolumeGeometryLibrary", "./PrimitiveType", "./VertexFormat", "./WindingOrder"], function (e, t, n, r, i, a, o, u, s, c, l, f, h, d, p, m, y, E, _, v, T, g, R) {
    "use strict";

    function A(e, t, r, i) {
      var o = new d();
      i.position && (o.position = new h({
        componentDatatype: a.DOUBLE,
        componentsPerAttribute: 3,
        values: e
      }));
      ...
      for (u = 0; u < A - 1; u++) {
        for (s = 0; s < g - 1; s++) {
          c = 2 * s + u * g * 2, v = c + I, l = c + 1, y = l + I, O[N++] = l, O[N++] = c, O[N++] = y, O[N++] = y, O[N++] = c, O[N++] = v;
        }

        c = 2 * g - 2 + u * g * 2, l = c + 1, y = l + I, v = c + I, O[N++] = l, O[N++] = c, O[N++] = y, O[N++] = y, O[N++] = c, O[N++] = v;
      }
      ...
      if (i.st || i.tangent || i.bitangent) {
        ...
        for (u = 0; u < A; u++) {
          for (x = u * P, M = b * (t[0].y + D), C[U++] = x, C[U++] = M, s = 1; s < g; s++) {
            M = b * (t[s].y + D), C[U++] = x, C[U++] = M, C[U++] = x, C[U++] = M;
          }
      ...
      for (u = 0; u < S.length; u += 3) {
        var F = S[u] + L,
            B = S[u + 1] + L,
            z = S[u + 2] + L;
        O[N++] = F, O[N++] = B, O[N++] = z, O[N++] = z + g, O[N++] = B + g, O[N++] = F + g;
      }
      ...
      if (i.normal && (q = p.computeNormal(q)), i.tangent || i.bitangent) {
        try {
          ...
          E("polyline-volume-tangent-bitangent", "Unable to compute tangents and bitangents for polyline volume geometry");
        }

        i.tangent || (q.attributes.tangent = void 0), i.bitangent || (q.attributes.bitangent = void 0), i.st || (q.attributes.st = void 0);
      }
    ...
    function S(e) {
      ...
      var t = e.polylinePositions,
          n = e.shapePositions;
      this._positions = t, this._shape = n, this._ellipsoid = l.clone(u(e.ellipsoid, l.WGS84)), this._cornerType = u(e.cornerType, o.ROUNDED), this._vertexFormat = g.clone(u(e.vertexFormat, g.DEFAULT)), this._granularity = u(e.granularity, y.RADIANS_PER_DEGREE), this._workerName = "createPolylineVolumeGeometry";
      var a = 1 + t.length * i.packedLength;
      a += 1 + n.length * r.packedLength, this.packedLength = a + l.packedLength + g.packedLength + 2;
    }
    ...
    S.pack = function (e, t, n) {
      ...
      return l.pack(e._ellipsoid, t, n), n += l.packedLength, g.pack(e._vertexFormat, t, n), n += g.packedLength, t[n++] = e._cornerType, t[n] = e._granularity, t;
    };
    ...
    S.unpack = function (e, t, n) {
      ...
      for (a = 0; a < o; ++a, t += i.packedLength) {
        c[a] = i.unpack(e, t);
      }
      ...
      for (a = 0; a < o; ++a, t += r.packedLength) {
        f[a] = r.unpack(e, t);
      }
      ...
      var p = e[t++],
          m = e[t];
      return s(n) ? (n._positions = c, n._shape = f, n._ellipsoid = l.clone(h, n._ellipsoid), n._vertexFormat = g.clone(d, n._vertexFormat), n._cornerType = p, n._granularity = m, n) : (I.polylinePositions = c, I.shapePositions = f, I.cornerType = p, I.granularity = m, new S(I));
    };

    var N = new t();
    return S.createGeometry = function (n) {
      var r = n._positions,
  ...
  }), define("Workers/createPolylineVolumeGeometry", ["../Core/defined", "../Core/Ellipsoid", "../Core/PolylineVolumeGeometry"], function (e, t, n) {
    "use strict";
