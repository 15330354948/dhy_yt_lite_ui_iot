...
"undefined" == typeof self && (self = {}), self.onmessage = function (e) {
  ...
  _require(t.loaderConfig, [t.workerModule], function (e) {
    self.onmessage = e, PGEARTH_BASE_URL = t.loaderConfig.baseUrl;
  });
}, function (global) {
  var req,
      s,
  ...
  function newContext(u) {
    ...
    function q(e, t, i) {
      ...
      if (e && (u = (e = e.split("/")).length - 1, g.nodeIdCompat && jsSuffixRegExp.test(e[u]) && (e[u] = e[u].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && l && (e = l.slice(0, l.length - 1).concat(e)), function (e) {
        for (var t, i = 0; i < e.length; i++) {
          if ("." === (t = e[i])) e.splice(i, 1), --i;else if (".." === t) {
        ...
        e: for (o = (n = e.split("/")).length; 0 < o; --o) {
          if (s = n.slice(0, o).join("/"), l) for (a = l.length; 0 < a; --a) {
    ...
    function w(e) {
      ...
      return t && isArray(t) && 1 < t.length && (t.shift(), l.require.undef(e), l.makeRequire(null, {
        skipMap: !0
      })([e]), 1);
    }
    ...
    function M(e, t, i) {
      var r = e.id,
          n = getOwn(p, r);
      !hasProp(m, r) || n && !n.defineEmitComplete ? (n = S(e)).error && "error" === t ? i(n.error) : n.on(t, i) : "defined" === t && i(m[r]);
    }
    ...
    function R() {
      ...
      if (!i) {
        ...
        }), n && o.length) return (e = makeError("timeout", "Load timeout for modules: " + o, null, o)).contextName = l.contextName, O(e), 0;
        u && each(a, function (e) {
          !function n(o, a, s) {
            var e = o.map.id;
    ...
    function a(e) {
      hasProp(m, e[0]) || S(k(e[0], null, !0)).init(e[1], e[2]);
    }
    ...
    function A() {
      ...
      for (j(); h.length;) {
        if (null === (e = h.shift())[0]) return O(makeError("mismatch", "Mismatched anonymous define() module: " + e[e.length - 1])), 0;
        a(e);
      }
    ...
    return c = {
          ...
          if (this.inited) {
            if (this.error) this.emit("error", this.error);else if (!this.defining) {
              if (this.defining = !0, this.depCount < 1 && !this.defined) {
                ...
                this.exports = n, this.map.isDefine && !this.ignore && (m[i] = n, req.onResourceLoad && req.onResourceLoad(l, this.map, this.depMaps)), P(i), this.defined = !0;
              }
      ...
      callPlugin: function callPlugin() {
        ...
        this.depMaps.push(e), M(e, "defined", bind(this, function (e) {
          ...
          return this.map.unnormalized ? (e.normalize && (n = e.normalize(n, function (e) {
            return q(e, a, !0);
          }) || ""), M(t = k(u.prefix + "!" + n, this.map.parentMap), "defined", bind(this, function (e) {
            this.init([], function () {
              return e;
            }, null, {
              enabled: !0,
            ...
            var i = u.name,
                r = k(i),
                n = useInteractive;
            t && (e = t), n && (useInteractive = !1), S(r), hasProp(g.config, c) && (g.config[i] = g.config[c]);
      ...
      enable: function enable() {
        (f[this.map.id] = this).enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function (e, t) {
          ...
          if ("string" == typeof e) {
            if (e = k(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap), this.depMaps[t] = e, n = getOwn(c, e.id)) return void (this.depExports[t] = n(this));
      ...
      configure: function configure(e) {
        ...
        eachProp(e, function (e, t) {
          ...
          isArray(e) && (e = {
            deps: e
          }), !e.exports && !e.init || e.exportsFn || (e.exportsFn = l.makeShimExports(e)), i[t] = e;
        }), g.shim = i), e.packages && each(e.packages, function (e) {
          var t = (e = "string" == typeof e ? {
            name: e
          } : e).name;
          e.location && (g.paths[t] = e.location), g.pkgs[t] = e.name + "/" + (e.main || "main").replace(currDirRegExp, "").replace(jsSuffixRegExp, "");
      ...
      makeRequire: function makeRequire(o, a) {
        ...
        return a = a || {}, mixin(s, {
          ...
          defined: function defined(e) {
            return hasProp(m, k(e, o, !1, !0).id);
          },
          specified: function specified(e) {
            return e = k(e, o, !1, !0).id, hasProp(m, e) || hasProp(p, e);
          }
      ...
      nameToUrl: function nameToUrl(e, t, i) {
        ...
        if (req.jsExtRegExp.test(e)) a = e + (t || "");else {
          ...
          a = n.join("/"), a = ("/" === (a += t || (/^data\:|\?/.test(a) || i ? "" : ".js")).charAt(0) || a.match(/^[\w\+\.\-]+:/) ? "" : g.baseUrl) + a;
        }
      ...
      onScriptLoad: function onScriptLoad(e) {
        var t;
        "load" !== e.type && !readyRegExp.test((e.currentTarget || e.srcElement).readyState) || (interactiveScript = null, t = s(e), l.completeLoad(t.id));
      },
      onScriptError: function onScriptError(e) {
        var t = s(e);
        if (!w(t.id)) return O(makeError("scripterror", "Script error for: " + t.id, e, [t.id]));
      }
