    ...
    define("Workers/LSJMemStream", [], function () {
      ...
      return t.prototype.TWO_POW_MINUS23 = Math.pow(2, -23), t.prototype.TWO_POW_MINUS126 = Math.pow(2, -126), t.prototype.isLittleEndian = function () {
        ...
        var r = this.readByte(),
            e = this.readByte();
        t += (127 & r) << 16;
        var a = (127 & e) << 1 | (128 & r) >>> 7,
            i = 128 & e ? -1 : 1;
        return 255 === a ? 0 !== t ? NaN : i * (1 / 0) : a > 0 ? i * (1 + t * this.TWO_POW_MINUS23) * Math.pow(2, a - 127) : 0 !== t ? i * t * this.TWO_POW_MINUS126 : 0 * i;
        ...
        var r = 4 * t,
            e = new DataView(this.data, this.curOffset, r);
        return this.curOffset += r, e;
        ...
        var r = new Uint8Array(this.data, this.curOffset, t);
        return this.curOffset += t, r;
      }, t.prototype.readString = function () {
        for (var t = this.readUInt32(), r = new Uint8Array(this.data, this.curOffset, t), e = "", a = 0; a < t; a++) {
