...
!function () {
  define("Core/defined", [], function () {
    ...
    function i(n, i, u, s, c) {
      ...
      do {
        B -= b, w = 1 / (1 + B * S), C = 1 / (1 + B * I), g = 1 / (1 + B * O), x = w * w, U = C * C, P = g * g, D = x * w, F = U * C, L = P * g, v = m * x + _ * U + y * P - 1, M = m * D * S + _ * F * I + y * L * O;
        b = v / (-2 * M);
    ...
    l.packedLength = 16, l.pack = function (e, t, n) {
      ...
      return r[0] = T * a, r[1] = S * a, r[2] = N * a, r[3] = 0, r[4] = R * o, r[5] = I * o, r[6] = v * o, r[7] = 0, r[8] = A * u, r[9] = O * u, r[10] = M * u, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, r;
    ...
    l.fromCamera = function (t, n) {
      ...
      var u = h.x,
          ...
          O = _ * -R + y * -A + T * -S,
          N = E * R + p * A + m * S;
      return i(n) ? (n[0] = u, n[1] = _, n[2] = -E, n[3] = 0, n[4] = s, n[5] = y, n[6] = -p, n[7] = 0, n[8] = c, n[9] = T, n[10] = -m, n[11] = 0, n[12] = I, n[13] = O, n[14] = N, n[15] = 1, n) : new l(u, s, c, I, _, y, T, O, -E, -p, -m, N, 0, 0, 0, 1);
    ...
    l.getMaximumScale = function (t) {
      ...
      var r = e[0],
          ...
          B = i * O + u * N + l * v + d,
          b = a * O + s * N + f * v + E;
      return n[0] = M, n[1] = w, n[2] = C, n[3] = 0, n[4] = g, n[5] = x, n[6] = U, n[7] = 0, n[8] = P, n[9] = D, n[10] = F, n[11] = 0, n[12] = L, n[13] = B, n[14] = b, n[15] = 1, n;
      ...
      var r = e[0],
          ...
          w = i * y + u * T + l * R,
          C = a * y + s * T + f * R;
      return n[0] = A, n[1] = S, n[2] = I, n[3] = 0, n[4] = O, n[5] = N, n[6] = v, n[7] = 0, n[8] = M, n[9] = w, n[10] = C, n[11] = 0, n[12] = e[12], n[13] = e[13], n[14] = e[14], n[15] = e[15], n;
    ...
    return l.inverse = function (e, n) {
      ...
      M = a * E, w = o * d, C = i * E, g = o * h, x = i * d, U = a * h, P = r * E, D = o * f, F = r * d, L = a * f, B = r * h, b = i * f;
    ...
    d.fromRectangle2D = function (e, t, n) {
      ...
      n = r(n, M), h.southwest(t, g), g.height = a, h.northeast(t, x), x.height = o;
      var s = n.project(g, w),
          c = n.project(x, C),
          l = c.x - s.x,
          f = c.y - s.y,
    ...
    function d() {
      if (!t(x)) {
        x = !1;
        var e;
        "Microsoft Internet Explorer" === O.appName ? null !== (e = /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(O.userAgent)) && (x = !0, U = o(e[1])) : "Netscape" === O.appName && null !== (e = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(O.userAgent)) && (x = !0, U = o(e[1]));
      }
    ...
    function R() {
      return t(b) || (b = !_() && "undefined" != typeof PointerEvent && (!t(O.pointerEnabled) || O.pointerEnabled)), b;
    }
    ...
    for (var C = new s(), g = 1.9011074535173003, x = i.supportsTypedArrays() ? new Float32Array(8) : [], U = i.supportsTypedArrays() ? new Float32Array(8) : [], P = i.supportsTypedArrays() ? new Float32Array(8) : [], D = i.supportsTypedArrays() ? new Float32Array(8) : [], F = 0; F < 7; ++F) {
      var L = F + 1,
          B = 2 * L + 1;
      x[F] = 1 / (L * B), U[F] = L / B;
    }

    return x[7] = g / 136, U[7] = 8 * g / 17, s.fastSlerp = function (e, t, n, r) {
      var i,
          a = s.dot(e, t);
      a >= 0 ? i = 1 : (i = -1, a = -a);
    ...
    p.fromGregorianDate = function (e, t) {
      ...
      var n,
          ...
          w = u[0],
          C = u[1];
      if (null !== (u = w.match(I))) n = +u[1], s = +u[2], l = +u[3];else if (null !== (u = w.match(R))) n = +u[1], s = +u[2];else if (null !== (u = w.match(T))) n = +u[1];else {
        var g;
        if (null !== (u = w.match(A))) n = +u[1], g = +u[2], a = o(n);else if (null !== (u = w.match(S))) {
          n = +u[1];
          var x = +u[2],
              U = +u[3] || 0,
      ...
      if (r(C)) {
        u = C.match(M), null !== u ? (h = +u[1], m = +u[2], y = +u[3], O = 1e3 * +(u[4] || 0), D = 5) : (u = C.match(v), null !== u ? (h = +u[1], m = +u[2], y = 60 * +(u[3] || 0), D = 4) : null !== (u = C.match(N)) && (h = +u[1], m = 60 * +(u[2] || 0), D = 3));
        var F = u[D],
            L = +u[D + 1],
            B = +(u[D + 2] || 0);
    ...
    function y(e) {
      var t = p(e);
      return e.state = l.ACTIVE, O.push(e), ++A.numberOfActiveRequests, ++A.numberOfActiveRequestsEver, ++N[e.serverKey], e.requestFunction().then(m(e)).otherwise(_(e)), t;
    }
    ...
    function P(e, n, r) {
      ...
      if (u(o)) return o.otherwise(function (i) {
        return a.state !== I.FAILED ? t.reject(i) : e.retryOnError(i).then(function (o) {
          return o ? (a.state = I.UNISSUED, a.deferred = void 0, P(e, n, r)) : t.reject(i);
        });
      });
    }
    ...
    x.supportsImageBitmapOptions = function () {
      ...
      var n = o(e.preferImageBitmap, !1),
          r = o(e.preferBlob, !1),
          i = o(e.flipY, !1);
      if (C(this.request), !q || this.isDataUri || this.isBlobUri || !this.hasHeaders && !r) return U({
        resource: this,
        flipY: i,
        preferImageBitmap: n
      });
    ...
    A.localFrameToFixedFrameGenerator = function (e, t) {
      ...
      return u(O[a]) ? r = O[a] : (r = function r(_r, a, s) {
        if (u(s) || (s = new y()), m.equalsEpsilon(_r.x, 0, m.EPSILON14) && m.equalsEpsilon(_r.y, 0, m.EPSILON14)) {
          var c = m.sign(_r.z);
          n.unpack(I[e], 0, v), "east" !== e && "west" !== e && n.multiplyByScalar(v, c, v), n.unpack(I[t], 0, M), "east" !== t && "west" !== t && n.multiplyByScalar(M, c, M), n.unpack(I[i], 0, w), "east" !== i && "west" !== i && n.multiplyByScalar(w, c, w);
        } else {
          a = o(a, f.WGS84), a.geodeticSurfaceNormal(_r, N.up);
          var l = N.up,
              h = N.east;
          h.x = -_r.y, h.y = _r.x, h.z = 0, n.normalize(h, N.east), n.cross(l, h, N.north), n.multiplyByScalar(N.up, -1, N.down), n.multiplyByScalar(N.east, -1, N.west), n.multiplyByScalar(N.north, -1, N.south), v = N[e], M = N[t], w = N[i];
        }
      ...
      if (u(n)) {
        ...
        if (u(a)) {
          ...
          var g = -47e-6 * C * m.RADIANS_PER_DEGREE / 3600,
              ...
              U = Math.sin(g),
              P = H;
          return P[0] = N * x, P[1] = N * U, P[2] = M, P[3] = -v * U + w * M * x, P[4] = v * x + w * M * U, P[5] = -w * N, P[6] = -w * U - v * M * x, P[7] = w * x - v * M * U, P[8] = v * N, _.multiply(O, P, t);
        }
      }
    };
    ...
    return m._textureCoordinateRotationPoints = function (r, i, a, o) {
      ...
      for (u = 0; u < 3; u++) {
        n.toCartesian(C[u], a, g), g = f.multiplyByPointAsVector(M, g, g), w[u].x = g.x, w[u].y = g.y;
      }
      ...
      for (u = 0; u < P; u++) {
        g = f.multiplyByPointAsVector(M, r[u], g), g = l.multiplyByVector(U, g, g), D = Math.min(D, g.x), F = Math.min(F, g.y), L = Math.max(L, g.x), B = Math.max(B, g.y);
      }
    ...
    return t;
  }), define("Core/BoxOutlineGeometry", ["./arrayFill", "./BoundingSphere", "./Cartesian3", "./Check", "./ComponentDatatype", "./defaultValue", "./defined", "./DeveloperError", "./Geometry", "./GeometryAttribute", "./GeometryAttributes", "./GeometryOffsetAttribute", "./PrimitiveType"], function (e, t, n, r, i, a, o, u, s, c, l, f, h) {
    "use strict";
    ...
    function d(e) {
      ...
      var t = e.minimum,
          r = e.maximum;
      this._min = n.clone(t), this._max = n.clone(r), this._offsetAttribute = e.offsetAttribute, this._workerName = "createBoxOutlineGeometry";
    }
    ...
    }, d.packedLength = 2 * n.packedLength + 1, d.pack = function (e, t, r) {
      return r = a(r, 0), n.pack(e._min, t, r), n.pack(e._max, t, r + n.packedLength), t[r + 2 * n.packedLength] = a(e._offsetAttribute, -1), t;
    };
    var p = new n(),
        m = new n(),
        _ = {
    ...
    return d.unpack = function (e, t, r) {
      ...
      return o(r) ? (r._min = n.clone(i, r._min), r._max = n.clone(u, r._max), r._offsetAttribute = -1 === s ? void 0 : s, r) : (_.offsetAttribute = -1 === s ? void 0 : s, new d(_));
      ...
      if (!n.equals(a, u)) {
        ...
        m[0] = a.x, m[1] = a.y, m[2] = a.z, m[3] = u.x, m[4] = a.y, m[5] = a.z, m[6] = u.x, m[7] = u.y, m[8] = a.z, m[9] = a.x, m[10] = u.y, m[11] = a.z, m[12] = a.x, m[13] = a.y, m[14] = u.z, m[15] = u.x, m[16] = a.y, m[17] = u.z, m[18] = u.x, m[19] = u.y, m[20] = u.z, m[21] = a.x, m[22] = u.y, m[23] = u.z, d.position = new c({
          componentDatatype: i.DOUBLE,
          componentsPerAttribute: 3,
          values: m
        }), p[0] = 4, p[1] = 5, p[2] = 5, p[3] = 6, p[4] = 6, p[5] = 7, p[6] = 7, p[7] = 4, p[8] = 0, p[9] = 1, p[10] = 1, p[11] = 2, p[12] = 2, p[13] = 3, p[14] = 3, p[15] = 0, p[16] = 0, p[17] = 4, p[18] = 1, p[19] = 5, p[20] = 2, p[21] = 6, p[22] = 3, p[23] = 7;
  ...
  }), define("Workers/createBoxOutlineGeometry", ["../Core/BoxOutlineGeometry", "../Core/defined"], function (e, t) {
    "use strict";
