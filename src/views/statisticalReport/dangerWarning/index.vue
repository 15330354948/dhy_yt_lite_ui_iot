  ...
  <div class="hide_mod">
    <basic-container>
        ...
        :data="list">
            <template slot="tip">
            <span class="yujing">
                总计：总预警次数：<a style="color:white">0</a>次;蓝色预警次数：<a style="color:#2168fa">0</a>次;黄色预警次数：<a style="color:#fce521">0</a>次;橙色预警次数：<a style="color:#e28d08">0</a>次;红色预警次数：<a style="color:#f05748">0</a>次
            </span>
            </template>
...
import { dangerPointOption } from "@/const/crud/statisticalReport/dangerWarning";
export default {
    name: "hidedanger",
