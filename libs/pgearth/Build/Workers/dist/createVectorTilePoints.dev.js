...
!function () {
  define("Core/defined", [], function () {
    ...
    return i.typeOf = {}, i.defined = function (r, i) {
      ...
      if (i.typeOf.number(t, n), n >= r) throw new e("Expected " + t + " to be less than " + r + ", actual value was " + n);
    }, i.typeOf.number.lessThanOrEquals = function (t, n, r) {
      if (i.typeOf.number(t, n), n > r) throw new e("Expected " + t + " to be less than or equal to " + r + ", actual value was " + n);
    }, i.typeOf.number.greaterThan = function (t, n, r) {
      if (i.typeOf.number(t, n), n <= r) throw new e("Expected " + t + " to be greater than " + r + ", actual value was " + n);
    }, i.typeOf.number.greaterThanOrEquals = function (t, n, r) {
      if (i.typeOf.number(t, n), n < r) throw new e("Expected " + t + " to be greater than or equal to" + r + ", actual value was " + n);
      ...
      if (i.typeOf.number(t, r), i.typeOf.number(n, o), r !== o) throw new e(t + " must be equal to " + n + ", the actual values are " + r + " and " + o);
    }, i;
  ...
  }), define("Core/Math", ["../ThirdParty/mersenne-twister", "./Check", "./defaultValue", "./defined", "./DeveloperError"], function (t, e, n, r, i) {
    "use strict";
    ...
    o.EPSILON1 = .1, o.EPSILON2 = .01, o.EPSILON3 = .001, o.EPSILON4 = 1e-4, o.EPSILON5 = 1e-5, o.EPSILON6 = 1e-6, o.EPSILON7 = 1e-7, o.EPSILON8 = 1e-8, o.EPSILON9 = 1e-9, o.EPSILON10 = 1e-10, o.EPSILON11 = 1e-11, o.EPSILON12 = 1e-12, o.EPSILON13 = 1e-13, o.EPSILON14 = 1e-14, o.EPSILON15 = 1e-15, o.EPSILON16 = 1e-16, o.EPSILON17 = 1e-17, o.EPSILON18 = 1e-18, o.EPSILON19 = 1e-19, o.EPSILON20 = 1e-20, o.EPSILON21 = 1e-21, o.GRAVITATIONALPARAMETER = 3986004418e5, o.SOLAR_RADIUS = 6955e5, o.LUNAR_RADIUS = 1737400, o.SIXTY_FOUR_KILOBYTES = 65536, o.sign = n(Math.sign, function (t) {
      ...
      return e = n(e, 255), Math.round((.5 * o.clamp(t, -1, 1) + .5) * e);
      ...
      return (1 - n) * t + n * e;
    }, o.PI = Math.PI, o.ONE_OVER_PI = 1 / Math.PI, o.PI_OVER_TWO = Math.PI / 2, o.PI_OVER_THREE = Math.PI / 3, o.PI_OVER_FOUR = Math.PI / 4, o.PI_OVER_SIX = Math.PI / 6, o.THREE_PI_OVER_TWO = 3 * Math.PI / 2, o.TWO_PI = 2 * Math.PI, o.ONE_OVER_TWO_PI = 1 / (2 * Math.PI), o.RADIANS_PER_DEGREE = Math.PI / 180, o.DEGREES_PER_RADIAN = 180 / Math.PI, o.RADIANS_PER_ARCSECOND = o.RADIANS_PER_DEGREE / 3600, o.toRadians = function (t) {
    ...
    o.factorial = function (t) {
      var e = a.length;
      if (t >= e) for (var n = a[e - 1], r = e; r <= t; r++) {
        a.push(n * r);
      }
      return a[t];
    ...
    var u = new t();
    return o.setRandomNumberSeed = function (e) {
      u = new t(e);
      ...
      var a = n / r;
      return i = o.fastApproximateAtan(a), i = Math.abs(e) > Math.abs(t) ? o.PI_OVER_TWO - i : i, i = t < 0 ? o.PI - i : i, i = e < 0 ? -i : i;
    }, o;
  }), define("Core/Cartesian2", ["./Check", "./defaultValue", "./defined", "./DeveloperError", "./freezeObject", "./Math"], function (t, e, n, r, i, o) {
    "use strict";
    ...
    }, a.fromCartesian3 = a.clone, a.fromCartesian4 = a.clone, a.packedLength = 2, a.pack = function (t, n, r) {
    ...
    a.lerp = function (t, e, n, r) {
      return a.multiplyByScalar(e, n, s), r = a.multiplyByScalar(t, 1 - n, r), a.add(s, r, r);
    };
    ...
    var f = new a();
    return a.mostOrthogonalAxis = function (t, e) {
      var n = a.normalize(t, f);
      return a.abs(n, n), e = n.x <= n.y ? a.clone(a.UNIT_X, e) : a.clone(a.UNIT_Y, e);
      ...
      return t === e || n(t) && n(e) && o.equalsEpsilon(t.x, e.x, r, i) && o.equalsEpsilon(t.y, e.y, r, i);
    }, a.ZERO = i(new a(0, 0)), a.UNIT_X = i(new a(1, 0)), a.UNIT_Y = i(new a(0, 1)), a.prototype.clone = function (t) {
  ...
  }), define("Core/Cartesian3", ["./Check", "./defaultValue", "./defined", "./DeveloperError", "./freezeObject", "./Math"], function (t, e, n, r, i, o) {
    "use strict";
    ...
    a.fromSpherical = function (t, r) {
      ...
      if (n(t)) return n(e) ? (e.x = t.x, e.y = t.y, e.z = t.z, e) : new a(t.x, t.y, t.z);
    }, a.fromCartesian4 = a.clone, a.packedLength = 3, a.pack = function (t, n, r) {
      return r = e(r, 0), n[r++] = t.x, n[r++] = t.y, n[r] = t.z, n;
    }, a.unpack = function (t, r, i) {
      return r = e(r, 0), n(i) || (i = new a()), i.x = t[r++], i.y = t[r++], i.z = t[r], i;
    }, a.packArray = function (t, e) {
      var r = t.length;
    ...
    a.mostOrthogonalAxis = function (t, e) {
      var n = a.normalize(t, f);
      return a.abs(n, n), e = n.x <= n.y ? n.x <= n.z ? a.clone(a.UNIT_X, e) : a.clone(a.UNIT_Z, e) : n.y <= n.z ? a.clone(a.UNIT_Y, e) : a.clone(a.UNIT_Z, e);
      ...
      return t === e || n(t) && n(e) && o.equalsEpsilon(t.x, e.x, r, i) && o.equalsEpsilon(t.y, e.y, r, i) && o.equalsEpsilon(t.z, e.z, r, i);
    ...
    return a.fromRadians = function (t, r, i, o, u) {
      i = e(i, 0);
      var s = n(o) ? o.radiiSquared : m,
          c = Math.cos(r);
      l.x = c * Math.cos(t), l.y = c * Math.sin(t), l.z = Math.sin(r), l = a.normalize(l, l), a.multiplyComponents(s, l, d);
      var h = Math.sqrt(a.dot(l, d));
      return d = a.divideByScalar(d, h, d), l = a.multiplyByScalar(l, i, l), n(u) || (u = new a()), a.add(d, l, u);
      ...
      return r;
    }, a.ZERO = i(new a(0, 0, 0)), a.UNIT_X = i(new a(1, 0, 0)), a.UNIT_Y = i(new a(0, 1, 0)), a.UNIT_Z = i(new a(0, 0, 1)), a.prototype.clone = function (t) {
      return a.clone(this, t);
    }, a.prototype.equals = function (t) {
      return a.equals(this, t);
    }, a.prototype.equalsEpsilon = function (t, e, n) {
  ...
  }), define("Core/AttributeCompression", ["./Cartesian2", "./Cartesian3", "./Check", "./defined", "./DeveloperError", "./Math"], function (t, e, n, r, i, o) {
    "use strict";
    ...
    s.octEncodeInRange = function (t, e, n) {
      if (n.x = t.x / (Math.abs(t.x) + Math.abs(t.y) + Math.abs(t.z)), n.y = t.y / (Math.abs(t.x) + Math.abs(t.y) + Math.abs(t.z)), t.z < 0) {
        var r = n.x,
            i = n.y;
        n.x = (1 - Math.abs(i)) * o.signNotZero(r), n.y = (1 - Math.abs(r)) * o.signNotZero(i);
      }
    ...
    s.octEncodeToCartesian4 = function (t, e) {
      return s.octEncodeInRange(t, 65535, c), e.x = a(c.x * (1 / 256)), e.y = a(c.x), e.z = a(c.y * (1 / 256)), e.w = a(c.y), e;
    }, s.octDecodeInRange = function (t, n, r, i) {
      if (i.x = o.fromSNorm(t, r), i.y = o.fromSNorm(n, r), i.z = 1 - (Math.abs(i.x) + Math.abs(i.y)), i.z < 0) {
        var a = i.x;
        i.x = (1 - Math.abs(i.y)) * o.signNotZero(a), i.y = (1 - Math.abs(a)) * o.signNotZero(i.y);
      }
    ...
    var f = new t();
    return s.octEncodeFloat = function (t) {
      ...
      for (var i = t.length, o = 0, a = 0, s = 0, c = 0; c < i; ++c) {
        o += u(t[c]), a += u(e[c]), t[c] = o, e[c] = a, r(n) && (s += u(n[c]), n[c] = s);
      }
    }, s;
    ...
    function i(n, i, u, s, c) {
      ...
      var P,
          ...
          q,
          L,
          k = (1 - x) * t.magnitude(n) / (.5 * t.magnitude(S)),
          D = 0;

      do {
        k -= D, T = 1 / (1 + k * _), I = 1 / (1 + k * E), b = 1 / (1 + k * O), A = T * T, z = I * I, C = b * b, N = A * T, q = z * I, L = C * b, P = y * A + g * z + v * C - 1, R = y * N * _ + g * q * E + v * L * O;
        D = P / (-2 * R);
      } while (Math.abs(P) > r.EPSILON12);

      return e(c) ? (c.x = h * T, c.y = f * I, c.z = l * b, c) : new t(h * T, f * I, l * b);
    }

    var o = new t(),
        a = new t();
    return i;
  }), define("Core/Cartographic", ["./Cartesian3", "./Check", "./defaultValue", "./defined", "./freezeObject", "./Math", "./scaleToGeodeticSurface"], function (t, e, n, r, i, o, a) {
    "use strict";
    ...
    u.fromRadians = function (t, e, i, o) {
      return i = n(i, 0), r(o) ? (o.longitude = t, o.latitude = e, o.height = i, o) : new u(t, e, i);
    ...
    var s = new t(),
        ...
        d = o.EPSILON1;
    return u.fromCartesian = function (e, n, i) {
      ...
      if (r(g)) {
        ...
        return r(i) ? (i.longitude = x, i.latitude = M, i.height = _, i) : new u(x, M, _);
      }
    }, u.toCartesian = function (e, n, r) {
      return t.fromRadians(e.longitude, e.latitude, e.height, n, r);
    }, u.clone = function (t, e) {
      if (r(t)) return r(e) ? (e.longitude = t.longitude, e.latitude = t.latitude, e.height = t.height, e) : new u(t.longitude, t.latitude, t.height);
    ...
    }, u.ZERO = i(new u(0, 0, 0)), u.prototype.clone = function (t) {
  ...
  }), define("Core/Ellipsoid", ["./Cartesian3", "./Cartographic", "./Check", "./defaultValue", "./defined", "./defineProperties", "./DeveloperError", "./freezeObject", "./Math", "./scaleToGeodeticSurface"], function (t, e, n, r, i, o, a, u, s, c) {
    "use strict";

    function h(e, n, i, o) {
      n = r(n, 0), i = r(i, 0), o = r(o, 0), e._radii = new t(n, i, o), e._radiiSquared = new t(n * n, i * i, o * o), e._radiiToTheFourth = new t(n * n * n * n, i * i * i * i, o * o * o * o), e._oneOverRadii = new t(0 === n ? 0 : 1 / n, 0 === i ? 0 : 1 / i, 0 === o ? 0 : 1 / o), e._oneOverRadiiSquared = new t(0 === n ? 0 : 1 / (n * n), 0 === i ? 0 : 1 / (i * i), 0 === o ? 0 : 1 / (o * o)), e._minimumRadius = Math.min(n, i, o), e._maximumRadius = Math.max(n, i, o), e._centerToleranceSquared = s.EPSILON1, 0 !== e._radiiSquared.z && (e._squaredXOverSquaredZ = e._radiiSquared.x / e._radiiSquared.z);
    }

    function f(t, e, n) {
      this._radii = void 0, this._radiiSquared = void 0, this._radiiToTheFourth = void 0, this._oneOverRadii = void 0, this._oneOverRadiiSquared = void 0, this._minimumRadius = void 0, this._maximumRadius = void 0, this._centerToleranceSquared = void 0, this._squaredXOverSquaredZ = void 0, h(this, t, e, n);
    }
    ...
    o(f.prototype, {
      ...
      return i(n) || (n = new t()), n = t.multiplyComponents(e, this._oneOverRadiiSquared, n), t.normalize(n, n);
    };
    var l = new t(),
        d = new t();
    f.prototype.cartographicToCartesian = function (e, n) {
      var r = l,
          o = d;
      this.geodeticSurfaceNormalCartographic(e, r), t.multiplyComponents(this._radiiSquared, r, o);
      var a = Math.sqrt(t.dot(r, o));
      return t.divideByScalar(o, a, o), t.multiplyByScalar(r, e.height, r), i(n) || (n = new t()), t.add(o, r, n);
    ...
    return f.prototype.cartesianToCartographic = function (n, r) {
      ...
      if (i(o)) {
        ...
        return i(r) ? (r.longitude = c, r.latitude = h, r.height = f, r) : new e(c, h, f);
      }
      ...
      return c(t, this._oneOverRadii, this._oneOverRadiiSquared, this._centerToleranceSquared, e);
      ...
      if (i(o) || (o = new t()), o.x = 0, o.y = 0, o.z = e.z * (1 - a), !(Math.abs(o.z) >= this._radii.z - n)) return o;
    }, f;
  }), define("Core/Rectangle", ["./Cartographic", "./Check", "./defaultValue", "./defined", "./defineProperties", "./Ellipsoid", "./freezeObject", "./Math"], function (t, e, n, r, i, o, a, u) {
    "use strict";

    function s(t, e, r, i) {
      this.west = n(t, 0), this.south = n(e, 0), this.east = n(r, 0), this.north = n(i, 0);
    }
    ...
    i(s.prototype, {
    ...
    }), s.packedLength = 4, s.pack = function (t, e, r) {
      return r = n(r, 0), e[r++] = t.west, e[r++] = t.south, e[r++] = t.east, e[r] = t.north, e;
    }, s.unpack = function (t, e, i) {
      return e = n(e, 0), r(i) || (i = new s()), i.west = t[e++], i.south = t[e++], i.east = t[e++], i.north = t[e], i;
      ...
      return t = u.toRadians(n(t, 0)), e = u.toRadians(n(e, 0)), i = u.toRadians(n(i, 0)), o = u.toRadians(n(o, 0)), r(a) ? (a.west = t, a.south = e, a.east = i, a.north = o, a) : new s(t, e, i, o);
    }, s.fromRadians = function (t, e, i, o, a) {
      return r(a) ? (a.west = n(t, 0), a.south = n(e, 0), a.east = n(i, 0), a.north = n(o, 0), a) : new s(t, e, i, o);
    }, s.fromCartographicArray = function (t, e) {
      for (var n = Number.MAX_VALUE, i = -Number.MAX_VALUE, o = Number.MAX_VALUE, a = -Number.MAX_VALUE, c = Number.MAX_VALUE, h = -Number.MAX_VALUE, f = 0, l = t.length; f < l; f++) {
        var d = t[f];
        n = Math.min(n, d.longitude), i = Math.max(i, d.longitude), c = Math.min(c, d.latitude), h = Math.max(h, d.latitude);
        var m = d.longitude >= 0 ? d.longitude : d.longitude + u.TWO_PI;
        o = Math.min(o, m), a = Math.max(a, m);
      }

      return i - n > a - o && (n = o, i = a, i > u.PI && (i -= u.TWO_PI), n > u.PI && (n -= u.TWO_PI)), r(e) ? (e.west = n, e.south = c, e.east = i, e.north = h, e) : new s(n, c, i, h);
    }, s.fromCartesianArray = function (t, e, i) {
      e = n(e, o.WGS84);

      for (var a = Number.MAX_VALUE, c = -Number.MAX_VALUE, h = Number.MAX_VALUE, f = -Number.MAX_VALUE, l = Number.MAX_VALUE, d = -Number.MAX_VALUE, m = 0, p = t.length; m < p; m++) {
        var y = e.cartesianToCartographic(t[m]);
        a = Math.min(a, y.longitude), c = Math.max(c, y.longitude), l = Math.min(l, y.latitude), d = Math.max(d, y.latitude);
        var g = y.longitude >= 0 ? y.longitude : y.longitude + u.TWO_PI;
        h = Math.min(h, g), f = Math.max(f, g);
      }

      return c - a > f - h && (a = h, c = f, c > u.PI && (c -= u.TWO_PI), a > u.PI && (a -= u.TWO_PI)), r(i) ? (i.west = a, i.south = l, i.east = c, i.north = d, i) : new s(a, l, c, d);
    }, s.clone = function (t, e) {
      if (r(t)) return r(e) ? (e.west = t.west, e.south = t.south, e.east = t.east, e.north = t.north, e) : new s(t.west, t.south, t.east, t.north);
    ...
    }, s.validate = function (t) {}, s.southwest = function (e, n) {
      ...
      var a = u.negativePiToPi(.5 * (o + i)),
          s = .5 * (e.south + e.north);
      return r(n) ? (n.longitude = a, n.latitude = s, n.height = 0, n) : new t(a, s);
      ...
      if (!((t.west < t.east || e.west < e.east) && f <= h)) {
        ...
        if (!(l >= d)) return r(n) ? (n.west = h, n.south = l, n.east = f, n.north = d, n) : new s(h, l, f, d);
      }
      ...
      if (!(o >= u || i >= a)) return r(n) ? (n.west = i, n.south = o, n.east = a, n.north = u, n) : new s(i, o, a, u);
      ...
      return n.west = h, n.south = Math.min(t.south, e.south), n.east = f, n.north = Math.max(t.north, e.north), n;
    }, s.expand = function (t, e, n) {
      return r(n) || (n = new s()), n.west = Math.min(t.west, e.longitude), n.south = Math.min(t.south, e.latitude), n.east = Math.max(t.east, e.longitude), n.north = Math.max(t.north, e.latitude), n;
    }, s.contains = function (t, e) {
      var n = e.longitude,
          r = e.latitude,
          i = t.west,
          o = t.east;
      return o < i && (o += u.TWO_PI, n < 0 && (n += u.TWO_PI)), (n > i || u.equalsEpsilon(n, i, u.EPSILON14)) && (n < o || u.equalsEpsilon(n, o, u.EPSILON14)) && r >= t.south && r <= t.north;
    };
    var c = new t();
    return s.subsample = function (t, e, i, a) {
      ...
      var h = 0,
          ...
          m = t.west,
          p = c;
      p.height = i, p.longitude = m, p.latitude = f, a[h] = e.cartographicToCartesian(p, a[h]), h++, p.longitude = d, a[h] = e.cartographicToCartesian(p, a[h]), h++, p.latitude = l, a[h] = e.cartographicToCartesian(p, a[h]), h++, p.longitude = m, a[h] = e.cartographicToCartesian(p, a[h]), h++, p.latitude = f < 0 ? f : l > 0 ? l : 0;

      for (var y = 1; y < 8; ++y) {
        p.longitude = -Math.PI + y * u.PI_OVER_TWO, s.contains(t, p) && (a[h] = e.cartographicToCartesian(p, a[h]), h++);
      }

      return 0 === p.latitude && (p.longitude = m, a[h] = e.cartographicToCartesian(p, a[h]), h++, p.longitude = d, a[h] = e.cartographicToCartesian(p, a[h]), h++), a.length = h, a;
    ...
    t("ThirdParty/when", [], function () {
      ...
      function e(t) {
        var e, n;
        return t instanceof r ? e = t : u(t) ? (n = a(), t.then(function (t) {
          n.resolve(t);
        }, function (t) {
          n.reject(t);
        }, function (t) {
      ...
      function a() {
        ...
        return c = new r(t), s = {
        ...
        }, h = [], f = [], l = function l(t, e, n) {
          var r, i;
          return r = a(), i = "function" == typeof n ? function (t) {
            try {
              r.progress(n(t));
            } catch (t) {
              r.progress(t);
          ...
          return t = e(t), l = t.then, _m = e, d = g, p(h, t), f = h = M, t;
        }, s;
      }
      ...
      function s(e, n, r, i, o) {
        return y(2, arguments), t(e, function (e) {
          function u(t) {
            _p(t);
          }
          ...
          var c, h, f, l, d, _m2, _p, y, v, w;

          if (v = e.length >>> 0, c = Math.max(0, Math.min(n, v)), f = [], h = v - c + 1, l = [], d = a(), c) for (y = d.progress, _p = function p(t) {
            l.push(t), --h || (_m2 = _p = g, d.reject(l));
          }, _m2 = function m(t) {
            f.push(t), --c || (_m2 = _p = g, d.resolve(f));
          }, w = 0; w < v; ++w) {
            w in e && t(e[w], s, u, y);
          } else d.resolve(f);
          return d.then(r, i, o);
      ...
      function l(e, n) {
        return t(e, function (e) {
          var r, i, o, u, s, c;
          if (o = i = e.length >>> 0, r = [], c = a(), o) for (u = function u(e, i) {
      ...
      function d(e, n) {
        ...
        return t(e, function (e) {
          var i;
          return i = e.length, r[0] = function (e, r, o) {
            return t(e, function (e) {
      ...
      var w, x, M;
      return t.defer = a, t.resolve = e, t.reject = n, t.join = f, t.all = h, t.map = l, t.reduce = d, t.any = c, t.some = s, t.chain = m, t.isPromise = u, r.prototype = {
      ...
      }, x = [].slice, w = [].reduce || function (t) {
        var e, n, r, i, o;
        if (o = 0, e = Object(this), i = e.length >>> 0, n = arguments, n.length <= 1) for (;;) {
          if (o in e) {
            r = e[o++];
            break;
          }
    ...
    function o(o) {
      ...
      return function (u) {
        ...
        return t(i(o, s.parameters, c)).then(function (t) {
          h.result = t;
        }).otherwise(function (t) {
          t instanceof Error ? h.error = {
            name: t.name,
            message: t.message,
            stack: t.stack
          } : h.error = t;
        }).always(function () {
          n(a) || (a = e(self.webkitPostMessage, self.postMessage)), s.canTransferArrayBuffer || (c.length = 0);

          try {
            a(h, c);
          } catch (t) {
            h.result = void 0, h.error = "postMessage failed with error: " + r(t) + "\n  with responseMessage: " + JSON.stringify(h), a(h);
          }
        });
      };
    }
    ...
    return o;
  }), define("Workers/createVectorTilePoints", ["../Core/AttributeCompression", "../Core/Cartesian3", "../Core/Cartographic", "../Core/Ellipsoid", "../Core/Math", "../Core/Rectangle", "./createTaskProcessorWorker"], function (t, e, n, r, i, o, a) {
    "use strict";

    function u(t) {
      t = new Float64Array(t);
      var e = 0;
      m.min = t[e++], m.max = t[e++], o.unpack(t, e, l), e += o.packedLength, r.unpack(t, e, d);
    }
